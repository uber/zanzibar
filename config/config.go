...
func productionJsonBytes() ([]byte, error) {
	return _productionJson, nil
}

func productionJson() (*asset, error) {
	bytes, err := productionJsonBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "production.json", size: 419, mode: os.FileMode(420), modTime: time.Unix(1, 0)}
...
var _bintree = &bintree{nil, map[string]*bintree{
	"production.json": &bintree{productionJson, map[string]*bintree{}},
}}
