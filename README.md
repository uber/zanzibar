...
To set max concurrent requests to client, set: 
```
	"clients.<clientID>.maxConcurrentRequests": 1000
```
To set error percent threshold beyond which to open the circuit to the client, set:
```
