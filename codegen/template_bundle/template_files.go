...
var _client_fixture_typesTmpl = []byte(`{{- /* template to render fixture type code for custom client */ -}}
{{- $imports := .Imports}}
{{- $methods := .Methods}}
...
func client_fixture_typesTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "client_fixture_types.tmpl", size: 1379, mode: os.FileMode(420), modTime: time.Unix(1, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}

var _client_mockTmpl = []byte(`{{- /* template to render client mock code for custom client */ -}}
{{- $methods := .Methods}}
...
func client_mockTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "client_mock.tmpl", size: 2171, mode: os.FileMode(420), modTime: time.Unix(1, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
