...
// sources:
// codegen/templates/client_fixture_types.tmpl
// codegen/templates/client_fixture_types_custom.tmpl
// codegen/templates/client_mock.tmpl
// codegen/templates/client_mock_custom.tmpl
...
func client_fixture_typesTmplBytes() ([]byte, error) {
	return _client_fixture_typesTmpl, nil
}

func client_fixture_typesTmpl() (*asset, error) {
	bytes, err := client_fixture_typesTmplBytes()
	if err != nil {
		return nil, err
	}
...
var _client_fixture_types_customTmpl = []byte(`{{- /* template to render fixture type code for custom client */ -}}
{{- $imports := .Imports}}
{{- $methods := .Methods}}
{{- $scenariosMap := .Fixture.Scenarios}}
package clientmock
...
func client_fixture_types_customTmplBytes() ([]byte, error) {
	return _client_fixture_types_customTmpl, nil
}

func client_fixture_types_customTmpl() (*asset, error) {
	bytes, err := client_fixture_types_customTmplBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "client_fixture_types_custom.tmpl", size: 1379, mode: os.FileMode(420), modTime: time.Unix(1, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func client_mockTmplBytes() ([]byte, error) {
	return _client_mockTmpl, nil
}

func client_mockTmpl() (*asset, error) {
	bytes, err := client_mockTmplBytes()
	if err != nil {
		return nil, err
	}
...
var _client_mock_customTmpl = []byte(`{{- /* template to render client mock code for custom client */ -}}
{{- $methods := .Methods}}
{{- $fixturePkg := .Fixture.ImportPath -}}
{{- $scenarios := .Fixture.Scenarios -}}
package clientmock
...
func client_mock_customTmplBytes() ([]byte, error) {
	return _client_mock_customTmpl, nil
}

func client_mock_customTmpl() (*asset, error) {
	bytes, err := client_mock_customTmplBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "client_mock_custom.tmpl", size: 2171, mode: os.FileMode(420), modTime: time.Unix(1, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
var _bindata = map[string]func() (*asset, error){
	"client_fixture_types.tmpl":          client_fixture_typesTmpl,
	"client_fixture_types_custom.tmpl":   client_fixture_types_customTmpl,
	"client_mock.tmpl":                   client_mockTmpl,
	"client_mock_custom.tmpl":            client_mock_customTmpl,
...
var _bintree = &bintree{nil, map[string]*bintree{
	"client_fixture_types.tmpl":          {client_fixture_typesTmpl, map[string]*bintree{}},
	"client_fixture_types_custom.tmpl":   {client_fixture_types_customTmpl, map[string]*bintree{}},
	"client_mock.tmpl":                   {client_mockTmpl, map[string]*bintree{}},
	"client_mock_custom.tmpl":            {client_mock_customTmpl, map[string]*bintree{}},
