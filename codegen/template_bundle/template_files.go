...
// sources:
// codegen/templates/adapter_http.tmpl
// codegen/templates/adapter_tchannel.tmpl
...
var _adapter_httpTmpl = []byte(`{{$instance := . -}}
...
func adapter_httpTmplBytes() ([]byte, error) {
	return _adapter_httpTmpl, nil
}

func adapter_httpTmpl() (*asset, error) {
	bytes, err := adapter_httpTmplBytes()
	if err != nil {
		return nil, err
	}
...
var _adapter_tchannelTmpl = []byte(`{{$instance := . -}}
...
func adapter_tchannelTmplBytes() ([]byte, error) {
	return _adapter_tchannelTmpl, nil
}

func adapter_tchannelTmpl() (*asset, error) {
	bytes, err := adapter_tchannelTmplBytes()
	if err != nil {
		return nil, err
	}
...
func endpointTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "endpoint.tmpl", size: 7133, mode: os.FileMode(420), modTime: time.Unix(1, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
var _bindata = map[string]func() (*asset, error){
	"adapter_http.tmpl":                  adapter_httpTmpl,
	"adapter_tchannel.tmpl":              adapter_tchannelTmpl,
...
var _bintree = &bintree{nil, map[string]*bintree{
	"adapter_http.tmpl":                  {adapter_httpTmpl, map[string]*bintree{}},
	"adapter_tchannel.tmpl":              {adapter_tchannelTmpl, map[string]*bintree{}},
