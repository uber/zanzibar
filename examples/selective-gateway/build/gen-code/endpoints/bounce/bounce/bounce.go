...
// Encode serializes a Bounce_Bounce_Args struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Bounce_Bounce_Args struct could not be encoded.
func (v *Bounce_Bounce_Args) Encode(sw stream.Writer) error {
...
// Decode deserializes a Bounce_Bounce_Args struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Bounce_Bounce_Args struct could not be generated from the wire
// representation.
func (v *Bounce_Bounce_Args) Decode(sr stream.Reader) error {
...
// Encode serializes a Bounce_Bounce_Result struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Bounce_Bounce_Result struct could not be encoded.
func (v *Bounce_Bounce_Result) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a Bounce_Bounce_Result struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Bounce_Bounce_Result struct could not be generated from the wire
// representation.
func (v *Bounce_Bounce_Result) Decode(sr stream.Reader) error {
