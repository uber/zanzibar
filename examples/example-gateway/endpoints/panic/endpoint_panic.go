...
import (
	...
	"github.com/uber/zanzibar/v2/examples/example-gateway/build/endpoints/panic/module"
	"github.com/uber/zanzibar/v2/examples/example-gateway/build/endpoints/panic/workflow"
