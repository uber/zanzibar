...
// Encode serializes a Request struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Request struct could not be encoded.
func (v *Request) Encode(sw stream.Writer) error {
	...
	if v.FirstName != nil {
		...
		if err := sw.WriteString(*(v.FirstName)); err != nil {
			return err
		}
	...
	if v.LastName != nil {
		...
		if err := sw.WriteString(*(v.LastName)); err != nil {
			return err
		}
		if err := sw.WriteFieldEnd(); err != nil {
			return err
...
// Decode deserializes a Request struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Request struct could not be generated from the wire
// representation.
func (v *Request) Decode(sr stream.Reader) error {
...
func (v *Response) Encode(sw stream.Writer) error {
	...
	if v.LastName1 != nil {
		...
		if err := sw.WriteString(*(v.LastName1)); err != nil {
			return err
		}
		if err := sw.WriteFieldEnd(); err != nil {
			return err
...
// Encode serializes a Clientless_Beta_Args struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Clientless_Beta_Args struct could not be encoded.
func (v *Clientless_Beta_Args) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
	...
	if v.Alpha != nil {
		...
		if err := sw.WriteString(*(v.Alpha)); err != nil {
			return err
		}
		if err := sw.WriteFieldEnd(); err != nil {
			return err
...
func _Request_Decode(sr stream.Reader) (*Request, error) {
	var v Request
	err := v.Decode(sr)
	return &v, err
}

// Decode deserializes a Clientless_Beta_Args struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Clientless_Beta_Args struct could not be generated from the wire
// representation.
func (v *Clientless_Beta_Args) Decode(sr stream.Reader) error {
	...
	for ok {
		...
		case fh.ID == 1 && fh.Type == wire.TStruct:
			v.Request, err = _Request_Decode(sr)
			if err != nil {
				return err
			}
...
// Encode serializes a Clientless_Beta_Result struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Clientless_Beta_Result struct could not be encoded.
func (v *Clientless_Beta_Result) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a Clientless_Beta_Result struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Clientless_Beta_Result struct could not be generated from the wire
// representation.
func (v *Clientless_Beta_Result) Decode(sr stream.Reader) error {
...
// Encode serializes a Clientless_ClientlessArgWithHeaders_Args struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Clientless_ClientlessArgWithHeaders_Args struct could not be encoded.
func (v *Clientless_ClientlessArgWithHeaders_Args) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a Clientless_ClientlessArgWithHeaders_Args struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Clientless_ClientlessArgWithHeaders_Args struct could not be generated from the wire
// representation.
func (v *Clientless_ClientlessArgWithHeaders_Args) Decode(sr stream.Reader) error {
...
// Encode serializes a Clientless_ClientlessArgWithHeaders_Result struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Clientless_ClientlessArgWithHeaders_Result struct could not be encoded.
func (v *Clientless_ClientlessArgWithHeaders_Result) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a Clientless_ClientlessArgWithHeaders_Result struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Clientless_ClientlessArgWithHeaders_Result struct could not be generated from the wire
// representation.
func (v *Clientless_ClientlessArgWithHeaders_Result) Decode(sr stream.Reader) error {
...
// Encode serializes a Clientless_EmptyclientlessRequest_Args struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Clientless_EmptyclientlessRequest_Args struct could not be encoded.
func (v *Clientless_EmptyclientlessRequest_Args) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
	...
	if v.TestString != nil {
		...
		if err := sw.WriteString(*(v.TestString)); err != nil {
			return err
		}
		if err := sw.WriteFieldEnd(); err != nil {
			return err
...
// Decode deserializes a Clientless_EmptyclientlessRequest_Args struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Clientless_EmptyclientlessRequest_Args struct could not be generated from the wire
// representation.
func (v *Clientless_EmptyclientlessRequest_Args) Decode(sr stream.Reader) error {
...
// Encode serializes a Clientless_EmptyclientlessRequest_Result struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Clientless_EmptyclientlessRequest_Result struct could not be encoded.
func (v *Clientless_EmptyclientlessRequest_Result) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a Clientless_EmptyclientlessRequest_Result struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Clientless_EmptyclientlessRequest_Result struct could not be generated from the wire
// representation.
func (v *Clientless_EmptyclientlessRequest_Result) Decode(sr stream.Reader) error {
