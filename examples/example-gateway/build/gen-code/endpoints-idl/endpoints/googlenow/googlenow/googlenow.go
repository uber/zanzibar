...
// Encode serializes a GoogleNow_AddCredentials_Args struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a GoogleNow_AddCredentials_Args struct could not be encoded.
func (v *GoogleNow_AddCredentials_Args) Encode(sw stream.Writer) error {
...
// Decode deserializes a GoogleNow_AddCredentials_Args struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a GoogleNow_AddCredentials_Args struct could not be generated from the wire
// representation.
func (v *GoogleNow_AddCredentials_Args) Decode(sr stream.Reader) error {
...
// Encode serializes a GoogleNow_AddCredentials_Result struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a GoogleNow_AddCredentials_Result struct could not be encoded.
func (v *GoogleNow_AddCredentials_Result) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a GoogleNow_AddCredentials_Result struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a GoogleNow_AddCredentials_Result struct could not be generated from the wire
// representation.
func (v *GoogleNow_AddCredentials_Result) Decode(sr stream.Reader) error {
...
// Encode serializes a GoogleNow_CheckCredentials_Args struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a GoogleNow_CheckCredentials_Args struct could not be encoded.
func (v *GoogleNow_CheckCredentials_Args) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a GoogleNow_CheckCredentials_Args struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a GoogleNow_CheckCredentials_Args struct could not be generated from the wire
// representation.
func (v *GoogleNow_CheckCredentials_Args) Decode(sr stream.Reader) error {
...
// Encode serializes a GoogleNow_CheckCredentials_Result struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a GoogleNow_CheckCredentials_Result struct could not be encoded.
func (v *GoogleNow_CheckCredentials_Result) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a GoogleNow_CheckCredentials_Result struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a GoogleNow_CheckCredentials_Result struct could not be generated from the wire
// representation.
func (v *GoogleNow_CheckCredentials_Result) Decode(sr stream.Reader) error {
