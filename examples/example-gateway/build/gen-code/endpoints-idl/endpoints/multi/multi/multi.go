...
// Encode serializes a ServiceAFront_Hello_Args struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a ServiceAFront_Hello_Args struct could not be encoded.
func (v *ServiceAFront_Hello_Args) Encode(sw stream.Writer) error {
...
// Decode deserializes a ServiceAFront_Hello_Args struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a ServiceAFront_Hello_Args struct could not be generated from the wire
// representation.
func (v *ServiceAFront_Hello_Args) Decode(sr stream.Reader) error {
...
// Encode serializes a ServiceAFront_Hello_Result struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a ServiceAFront_Hello_Result struct could not be encoded.
func (v *ServiceAFront_Hello_Result) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a ServiceAFront_Hello_Result struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a ServiceAFront_Hello_Result struct could not be generated from the wire
// representation.
func (v *ServiceAFront_Hello_Result) Decode(sr stream.Reader) error {
...
// Encode serializes a ServiceBFront_Hello_Args struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a ServiceBFront_Hello_Args struct could not be encoded.
func (v *ServiceBFront_Hello_Args) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a ServiceBFront_Hello_Args struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a ServiceBFront_Hello_Args struct could not be generated from the wire
// representation.
func (v *ServiceBFront_Hello_Args) Decode(sr stream.Reader) error {
...
// Encode serializes a ServiceBFront_Hello_Result struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a ServiceBFront_Hello_Result struct could not be encoded.
func (v *ServiceBFront_Hello_Result) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a ServiceBFront_Hello_Result struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a ServiceBFront_Hello_Result struct could not be generated from the wire
// representation.
func (v *ServiceBFront_Hello_Result) Decode(sr stream.Reader) error {
...
// Encode serializes a ServiceCFront_Hello_Args struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a ServiceCFront_Hello_Args struct could not be encoded.
func (v *ServiceCFront_Hello_Args) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a ServiceCFront_Hello_Args struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a ServiceCFront_Hello_Args struct could not be generated from the wire
// representation.
func (v *ServiceCFront_Hello_Args) Decode(sr stream.Reader) error {
...
// Encode serializes a ServiceCFront_Hello_Result struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a ServiceCFront_Hello_Result struct could not be encoded.
func (v *ServiceCFront_Hello_Result) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a ServiceCFront_Hello_Result struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a ServiceCFront_Hello_Result struct could not be generated from the wire
// representation.
func (v *ServiceCFront_Hello_Result) Decode(sr stream.Reader) error {
