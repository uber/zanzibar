...
import (
	...
	base "github.com/uber/zanzibar/v2/examples/example-gateway/build/gen-code/clients-idl/clients/baz/base"
...
// Encode serializes a TransHeaderType struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a TransHeaderType struct could not be encoded.
func (v *TransHeaderType) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
	...
	if v.I1 != nil {
		...
		if err := sw.WriteInt32(*(v.I1)); err != nil {
			return err
		}
		if err := sw.WriteFieldEnd(); err != nil {
			return err
	...
	if err := sw.WriteInt64(v.I2); err != nil {
		return err
	}
	if err := sw.WriteFieldEnd(); err != nil {
		return err
	...
	if v.F3 != nil {
		...
		if err := sw.WriteDouble(*(v.F3)); err != nil {
			return err
		}
		if err := sw.WriteFieldEnd(); err != nil {
			return err
	...
	if err := sw.WriteString(v.S6); err != nil {
		return err
	}
	if err := sw.WriteFieldEnd(); err != nil {
		return err
...
// Decode deserializes a TransHeaderType struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a TransHeaderType struct could not be generated from the wire
// representation.
func (v *TransHeaderType) Decode(sr stream.Reader) error {
...
// Encode serializes a SecondService_EchoBinary_Args struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a SecondService_EchoBinary_Args struct could not be encoded.
func (v *SecondService_EchoBinary_Args) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a SecondService_EchoBinary_Args struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a SecondService_EchoBinary_Args struct could not be generated from the wire
// representation.
func (v *SecondService_EchoBinary_Args) Decode(sr stream.Reader) error {
...
// Encode serializes a SecondService_EchoBinary_Result struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a SecondService_EchoBinary_Result struct could not be encoded.
func (v *SecondService_EchoBinary_Result) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a SecondService_EchoBinary_Result struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a SecondService_EchoBinary_Result struct could not be generated from the wire
// representation.
func (v *SecondService_EchoBinary_Result) Decode(sr stream.Reader) error {
...
// Encode serializes a SecondService_EchoBool_Args struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a SecondService_EchoBool_Args struct could not be encoded.
func (v *SecondService_EchoBool_Args) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a SecondService_EchoBool_Args struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a SecondService_EchoBool_Args struct could not be generated from the wire
// representation.
func (v *SecondService_EchoBool_Args) Decode(sr stream.Reader) error {
...
// Encode serializes a SecondService_EchoBool_Result struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a SecondService_EchoBool_Result struct could not be encoded.
func (v *SecondService_EchoBool_Result) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a SecondService_EchoBool_Result struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a SecondService_EchoBool_Result struct could not be generated from the wire
// representation.
func (v *SecondService_EchoBool_Result) Decode(sr stream.Reader) error {
...
// Encode serializes a SecondService_EchoDouble_Args struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a SecondService_EchoDouble_Args struct could not be encoded.
func (v *SecondService_EchoDouble_Args) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a SecondService_EchoDouble_Args struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a SecondService_EchoDouble_Args struct could not be generated from the wire
// representation.
func (v *SecondService_EchoDouble_Args) Decode(sr stream.Reader) error {
...
// Encode serializes a SecondService_EchoDouble_Result struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a SecondService_EchoDouble_Result struct could not be encoded.
func (v *SecondService_EchoDouble_Result) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a SecondService_EchoDouble_Result struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a SecondService_EchoDouble_Result struct could not be generated from the wire
// representation.
func (v *SecondService_EchoDouble_Result) Decode(sr stream.Reader) error {
...
// Default_SecondService_EchoEnum_Args constructs a new SecondService_EchoEnum_Args struct,
...
// Encode serializes a SecondService_EchoEnum_Args struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a SecondService_EchoEnum_Args struct could not be encoded.
func (v *SecondService_EchoEnum_Args) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a SecondService_EchoEnum_Args struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a SecondService_EchoEnum_Args struct could not be generated from the wire
// representation.
func (v *SecondService_EchoEnum_Args) Decode(sr stream.Reader) error {
...
// Encode serializes a SecondService_EchoEnum_Result struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a SecondService_EchoEnum_Result struct could not be encoded.
func (v *SecondService_EchoEnum_Result) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a SecondService_EchoEnum_Result struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a SecondService_EchoEnum_Result struct could not be generated from the wire
// representation.
func (v *SecondService_EchoEnum_Result) Decode(sr stream.Reader) error {
...
// Encode serializes a SecondService_EchoI16_Args struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a SecondService_EchoI16_Args struct could not be encoded.
func (v *SecondService_EchoI16_Args) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a SecondService_EchoI16_Args struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a SecondService_EchoI16_Args struct could not be generated from the wire
// representation.
func (v *SecondService_EchoI16_Args) Decode(sr stream.Reader) error {
...
// Encode serializes a SecondService_EchoI16_Result struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a SecondService_EchoI16_Result struct could not be encoded.
func (v *SecondService_EchoI16_Result) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a SecondService_EchoI16_Result struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a SecondService_EchoI16_Result struct could not be generated from the wire
// representation.
func (v *SecondService_EchoI16_Result) Decode(sr stream.Reader) error {
...
// Encode serializes a SecondService_EchoI32_Args struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a SecondService_EchoI32_Args struct could not be encoded.
func (v *SecondService_EchoI32_Args) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a SecondService_EchoI32_Args struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a SecondService_EchoI32_Args struct could not be generated from the wire
// representation.
func (v *SecondService_EchoI32_Args) Decode(sr stream.Reader) error {
...
// Encode serializes a SecondService_EchoI32_Result struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a SecondService_EchoI32_Result struct could not be encoded.
func (v *SecondService_EchoI32_Result) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a SecondService_EchoI32_Result struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a SecondService_EchoI32_Result struct could not be generated from the wire
// representation.
func (v *SecondService_EchoI32_Result) Decode(sr stream.Reader) error {
...
// Encode serializes a SecondService_EchoI64_Args struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a SecondService_EchoI64_Args struct could not be encoded.
func (v *SecondService_EchoI64_Args) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a SecondService_EchoI64_Args struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a SecondService_EchoI64_Args struct could not be generated from the wire
// representation.
func (v *SecondService_EchoI64_Args) Decode(sr stream.Reader) error {
...
// Encode serializes a SecondService_EchoI64_Result struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a SecondService_EchoI64_Result struct could not be encoded.
func (v *SecondService_EchoI64_Result) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a SecondService_EchoI64_Result struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a SecondService_EchoI64_Result struct could not be generated from the wire
// representation.
func (v *SecondService_EchoI64_Result) Decode(sr stream.Reader) error {
...
// Encode serializes a SecondService_EchoI8_Args struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a SecondService_EchoI8_Args struct could not be encoded.
func (v *SecondService_EchoI8_Args) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a SecondService_EchoI8_Args struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a SecondService_EchoI8_Args struct could not be generated from the wire
// representation.
func (v *SecondService_EchoI8_Args) Decode(sr stream.Reader) error {
...
// Encode serializes a SecondService_EchoI8_Result struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a SecondService_EchoI8_Result struct could not be encoded.
func (v *SecondService_EchoI8_Result) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a SecondService_EchoI8_Result struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a SecondService_EchoI8_Result struct could not be generated from the wire
// representation.
func (v *SecondService_EchoI8_Result) Decode(sr stream.Reader) error {
...
// Encode serializes a SecondService_EchoString_Args struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a SecondService_EchoString_Args struct could not be encoded.
func (v *SecondService_EchoString_Args) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a SecondService_EchoString_Args struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a SecondService_EchoString_Args struct could not be generated from the wire
// representation.
func (v *SecondService_EchoString_Args) Decode(sr stream.Reader) error {
...
// Encode serializes a SecondService_EchoString_Result struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a SecondService_EchoString_Result struct could not be encoded.
func (v *SecondService_EchoString_Result) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a SecondService_EchoString_Result struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a SecondService_EchoString_Result struct could not be generated from the wire
// representation.
func (v *SecondService_EchoString_Result) Decode(sr stream.Reader) error {
...
// Encode serializes a SecondService_EchoStringList_Args struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a SecondService_EchoStringList_Args struct could not be encoded.
func (v *SecondService_EchoStringList_Args) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a SecondService_EchoStringList_Args struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a SecondService_EchoStringList_Args struct could not be generated from the wire
// representation.
func (v *SecondService_EchoStringList_Args) Decode(sr stream.Reader) error {
...
// Encode serializes a SecondService_EchoStringList_Result struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a SecondService_EchoStringList_Result struct could not be encoded.
func (v *SecondService_EchoStringList_Result) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a SecondService_EchoStringList_Result struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a SecondService_EchoStringList_Result struct could not be generated from the wire
// representation.
func (v *SecondService_EchoStringList_Result) Decode(sr stream.Reader) error {
...
func (m _Map_String_BazResponse_MapItemList) ForEach(f func(wire.MapItem) error) error {
	for k, v := range m {
		if v == nil {
			return fmt.Errorf("invalid map 'map[string]*base.BazResponse', key [%v]: value is nil", k)
		}
...
func _Map_String_BazResponse_Encode(val map[string]*base.BazResponse, sw stream.Writer) error {
...
// Encode serializes a SecondService_EchoStringMap_Args struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a SecondService_EchoStringMap_Args struct could not be encoded.
func (v *SecondService_EchoStringMap_Args) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
	...
	if err := _Map_String_BazResponse_Encode(v.Arg, sw); err != nil {
		return err
	}
	if err := sw.WriteFieldEnd(); err != nil {
		return err
...
func _BazResponse_Decode(sr stream.Reader) (*base.BazResponse, error) {
	var v base.BazResponse
	err := v.Decode(sr)
	return &v, err
}

func _Map_String_BazResponse_Decode(sr stream.Reader) (map[string]*base.BazResponse, error) {
	mh, err := sr.ReadMapBegin()
	if err != nil {
		return nil, err
	}
	...
	o := make(map[string]*base.BazResponse, mh.Length)
	for i := 0; i < mh.Length; i++ {
		k, err := sr.ReadString()
		if err != nil {
			return nil, err
...
// Decode deserializes a SecondService_EchoStringMap_Args struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a SecondService_EchoStringMap_Args struct could not be generated from the wire
// representation.
func (v *SecondService_EchoStringMap_Args) Decode(sr stream.Reader) error {
	...
	for ok {
		switch {
		case fh.ID == 1 && fh.Type == wire.TMap:
			v.Arg, err = _Map_String_BazResponse_Decode(sr)
			if err != nil {
				return err
			}
			argIsSet = true
...
// Encode serializes a SecondService_EchoStringMap_Result struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a SecondService_EchoStringMap_Result struct could not be encoded.
func (v *SecondService_EchoStringMap_Result) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
	...
	if v.Success != nil {
		...
		if err := _Map_String_BazResponse_Encode(v.Success, sw); err != nil {
			return err
		}
		if err := sw.WriteFieldEnd(); err != nil {
			return err
...
// Decode deserializes a SecondService_EchoStringMap_Result struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a SecondService_EchoStringMap_Result struct could not be generated from the wire
// representation.
func (v *SecondService_EchoStringMap_Result) Decode(sr stream.Reader) error {
	...
	for ok {
		...
		case fh.ID == 0 && fh.Type == wire.TMap:
			v.Success, err = _Map_String_BazResponse_Decode(sr)
			if err != nil {
				return err
			}
...
// Encode serializes a SecondService_EchoStringSet_Args struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a SecondService_EchoStringSet_Args struct could not be encoded.
func (v *SecondService_EchoStringSet_Args) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a SecondService_EchoStringSet_Args struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a SecondService_EchoStringSet_Args struct could not be generated from the wire
// representation.
func (v *SecondService_EchoStringSet_Args) Decode(sr stream.Reader) error {
...
// Encode serializes a SecondService_EchoStringSet_Result struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a SecondService_EchoStringSet_Result struct could not be encoded.
func (v *SecondService_EchoStringSet_Result) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a SecondService_EchoStringSet_Result struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a SecondService_EchoStringSet_Result struct could not be generated from the wire
// representation.
func (v *SecondService_EchoStringSet_Result) Decode(sr stream.Reader) error {
...
func (v _List_BazResponse_ValueList) ForEach(f func(wire.Value) error) error {
	for i, x := range v {
		if x == nil {
			return fmt.Errorf("invalid list '[]*base.BazResponse', index [%v]: value is nil", i)
		}
		w, err := x.ToWire()
		if err != nil {
			return err
...
func _List_BazResponse_Encode(val []*base.BazResponse, sw stream.Writer) error {
...
// Encode serializes a SecondService_EchoStructList_Args struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a SecondService_EchoStructList_Args struct could not be encoded.
func (v *SecondService_EchoStructList_Args) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
	...
	if err := _List_BazResponse_Encode(v.Arg, sw); err != nil {
		return err
	}
	if err := sw.WriteFieldEnd(); err != nil {
		return err
...
func _List_BazResponse_Decode(sr stream.Reader) ([]*base.BazResponse, error) {
	lh, err := sr.ReadListBegin()
	if err != nil {
		return nil, err
	}
	...
	o := make([]*base.BazResponse, 0, lh.Length)
	for i := 0; i < lh.Length; i++ {
		v, err := _BazResponse_Decode(sr)
		if err != nil {
			return nil, err
...
// Decode deserializes a SecondService_EchoStructList_Args struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a SecondService_EchoStructList_Args struct could not be generated from the wire
// representation.
func (v *SecondService_EchoStructList_Args) Decode(sr stream.Reader) error {
	...
	for ok {
		switch {
		case fh.ID == 1 && fh.Type == wire.TList:
			v.Arg, err = _List_BazResponse_Decode(sr)
			if err != nil {
				return err
			}
			argIsSet = true
...
// Encode serializes a SecondService_EchoStructList_Result struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a SecondService_EchoStructList_Result struct could not be encoded.
func (v *SecondService_EchoStructList_Result) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
	...
	if v.Success != nil {
		...
		if err := _List_BazResponse_Encode(v.Success, sw); err != nil {
			return err
		}
		if err := sw.WriteFieldEnd(); err != nil {
			return err
...
// Decode deserializes a SecondService_EchoStructList_Result struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a SecondService_EchoStructList_Result struct could not be generated from the wire
// representation.
func (v *SecondService_EchoStructList_Result) Decode(sr stream.Reader) error {
	...
	for ok {
		switch {
		case fh.ID == 0 && fh.Type == wire.TList:
			v.Success, err = _List_BazResponse_Decode(sr)
			if err != nil {
				return err
			}
...
func (m _Map_BazResponse_String_MapItemList) ForEach(f func(wire.MapItem) error) error {
	for _, i := range m {
		...
		v := i.Value
		if k == nil {
			return fmt.Errorf("invalid map '[]struct{Key *base.BazResponse; Value string}': key is nil")
		}
		kw, err := k.ToWire()
		if err != nil {
			return err
...
func _Map_BazResponse_String_Encode(val []struct {
	Key   *base.BazResponse
	Value string
...
// Encode serializes a SecondService_EchoStructMap_Args struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a SecondService_EchoStructMap_Args struct could not be encoded.
func (v *SecondService_EchoStructMap_Args) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
	...
	if err := _Map_BazResponse_String_Encode(v.Arg, sw); err != nil {
		return err
	}
	if err := sw.WriteFieldEnd(); err != nil {
		return err
...
func _Map_BazResponse_String_Decode(sr stream.Reader) ([]struct {
	Key   *base.BazResponse
	Value string
}, error) {
	mh, err := sr.ReadMapBegin()
...
// Decode deserializes a SecondService_EchoStructMap_Args struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a SecondService_EchoStructMap_Args struct could not be generated from the wire
// representation.
func (v *SecondService_EchoStructMap_Args) Decode(sr stream.Reader) error {
	...
	for ok {
		switch {
		case fh.ID == 1 && fh.Type == wire.TMap:
			v.Arg, err = _Map_BazResponse_String_Decode(sr)
			if err != nil {
				return err
			}
			argIsSet = true
...
// Encode serializes a SecondService_EchoStructMap_Result struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a SecondService_EchoStructMap_Result struct could not be encoded.
func (v *SecondService_EchoStructMap_Result) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
	...
	if v.Success != nil {
		...
		if err := _Map_BazResponse_String_Encode(v.Success, sw); err != nil {
			return err
		}
		if err := sw.WriteFieldEnd(); err != nil {
			return err
...
// Decode deserializes a SecondService_EchoStructMap_Result struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a SecondService_EchoStructMap_Result struct could not be generated from the wire
// representation.
func (v *SecondService_EchoStructMap_Result) Decode(sr stream.Reader) error {
	...
	for ok {
		switch {
		case fh.ID == 0 && fh.Type == wire.TMap:
			v.Success, err = _Map_BazResponse_String_Decode(sr)
			if err != nil {
				return err
			}
...
func (v _Set_BazResponse_sliceType_ValueList) ForEach(f func(wire.Value) error) error {
	for _, x := range v {
		if x == nil {
			return fmt.Errorf("invalid set '*base.BazResponse': contains nil value")
		}
		w, err := x.ToWire()
		if err != nil {
			return err
...
func _Set_BazResponse_sliceType_Encode(val []*base.BazResponse, sw stream.Writer) error {
...
// Encode serializes a SecondService_EchoStructSet_Args struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a SecondService_EchoStructSet_Args struct could not be encoded.
func (v *SecondService_EchoStructSet_Args) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
	...
	if err := _Set_BazResponse_sliceType_Encode(v.Arg, sw); err != nil {
		return err
	}
	if err := sw.WriteFieldEnd(); err != nil {
		return err
...
func _Set_BazResponse_sliceType_Decode(sr stream.Reader) ([]*base.BazResponse, error) {
	sh, err := sr.ReadSetBegin()
	if err != nil {
		return nil, err
	}
	...
	o := make([]*base.BazResponse, 0, sh.Length)
	for i := 0; i < sh.Length; i++ {
		v, err := _BazResponse_Decode(sr)
		if err != nil {
			return nil, err
...
// Decode deserializes a SecondService_EchoStructSet_Args struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a SecondService_EchoStructSet_Args struct could not be generated from the wire
// representation.
func (v *SecondService_EchoStructSet_Args) Decode(sr stream.Reader) error {
	...
	for ok {
		switch {
		case fh.ID == 1 && fh.Type == wire.TSet:
			v.Arg, err = _Set_BazResponse_sliceType_Decode(sr)
			if err != nil {
				return err
			}
			argIsSet = true
...
// Encode serializes a SecondService_EchoStructSet_Result struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a SecondService_EchoStructSet_Result struct could not be encoded.
func (v *SecondService_EchoStructSet_Result) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
	...
	if v.Success != nil {
		...
		if err := _Set_BazResponse_sliceType_Encode(v.Success, sw); err != nil {
			return err
		}
		if err := sw.WriteFieldEnd(); err != nil {
			return err
...
// Decode deserializes a SecondService_EchoStructSet_Result struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a SecondService_EchoStructSet_Result struct could not be generated from the wire
// representation.
func (v *SecondService_EchoStructSet_Result) Decode(sr stream.Reader) error {
	...
	for ok {
		switch {
		case fh.ID == 0 && fh.Type == wire.TSet:
			v.Success, err = _Set_BazResponse_sliceType_Decode(sr)
			if err != nil {
				return err
			}
...
// Encode serializes a SecondService_EchoTypedef_Args struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a SecondService_EchoTypedef_Args struct could not be encoded.
func (v *SecondService_EchoTypedef_Args) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
func _UUID_1_Decode(sr stream.Reader) (base.UUID, error) {
	var x base.UUID
	err := x.Decode(sr)
	return x, err
}

// Decode deserializes a SecondService_EchoTypedef_Args struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a SecondService_EchoTypedef_Args struct could not be generated from the wire
// representation.
func (v *SecondService_EchoTypedef_Args) Decode(sr stream.Reader) error {
...
// Encode serializes a SecondService_EchoTypedef_Result struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a SecondService_EchoTypedef_Result struct could not be encoded.
func (v *SecondService_EchoTypedef_Result) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a SecondService_EchoTypedef_Result struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a SecondService_EchoTypedef_Result struct could not be generated from the wire
// representation.
func (v *SecondService_EchoTypedef_Result) Decode(sr stream.Reader) error {
...
func _ServerErr_Decode(sr stream.Reader) (*base.ServerErr, error) {
	var v base.ServerErr
	err := v.Decode(sr)
	return &v, err
}
...
func _TransStruct_Decode(sr stream.Reader) (*base.TransStruct, error) {
	var v base.TransStruct
	err := v.Decode(sr)
	return &v, err
}
...
func _TransHeaders_Decode(sr stream.Reader) (*base.TransHeaders, error) {
	var v base.TransHeaders
	err := v.Decode(sr)
	return &v, err
}
...
func (v *SimpleService_TransHeaders_Args) Decode(sr stream.Reader) error {
	...
	for ok {
		switch {
		case fh.ID == 1 && fh.Type == wire.TStruct:
			v.Req, err = _TransHeaders_Decode(sr)
			if err != nil {
				return err
			}
			reqIsSet = true
...
func (v *SimpleService_TransHeaders_Result) Decode(sr stream.Reader) error {
	...
	for ok {
		switch {
		case fh.ID == 0 && fh.Type == wire.TStruct:
			v.Success, err = _TransHeaders_Decode(sr)
			if err != nil {
				return err
			}
...
func (v *SimpleService_TransHeadersNoReq_Args) Encode(sw stream.Writer) error {
	...
	if v.B4 != nil {
		...
		if err := sw.WriteBool(*(v.B4)); err != nil {
			return err
		}
		if err := sw.WriteFieldEnd(); err != nil {
			return err
...
func _NestedStruct_Decode(sr stream.Reader) (*base.NestedStruct, error) {
	var v base.NestedStruct
	err := v.Decode(sr)
	return &v, err
}
...
func (v *SimpleService_TransHeadersNoReq_Args) Decode(sr stream.Reader) error {
	...
	for ok {
		switch {
		case fh.ID == 1 && fh.Type == wire.TStruct:
			v.Req, err = _NestedStruct_Decode(sr)
			if err != nil {
				return err
			}
			reqIsSet = true
...
func _TransHeaderType_Decode(sr stream.Reader) (*TransHeaderType, error) {
	var v TransHeaderType
	err := v.Decode(sr)
	return &v, err
}
...
func (v *SimpleService_TransHeadersType_Args) Decode(sr stream.Reader) error {
	...
	for ok {
		switch {
		case fh.ID == 1 && fh.Type == wire.TStruct:
			v.Req, err = _TransHeaderType_Decode(sr)
			if err != nil {
				return err
			}
			reqIsSet = true
...
func (v *SimpleService_TransHeadersType_Result) Decode(sr stream.Reader) error {
	...
	for ok {
		switch {
		case fh.ID == 0 && fh.Type == wire.TStruct:
			v.Success, err = _TransHeaderType_Decode(sr)
			if err != nil {
				return err
			}
