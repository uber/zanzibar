...
// Encode serializes a BarException struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a BarException struct could not be encoded.
func (v *BarException) Encode(sw stream.Writer) error {
...
// Decode deserializes a BarException struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a BarException struct could not be generated from the wire
// representation.
func (v *BarException) Decode(sr stream.Reader) error {
...
// Encode serializes a BarRequest struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a BarRequest struct could not be encoded.
func (v *BarRequest) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
	...
	if err := v.Timestamp.Encode(sw); err != nil {
		return err
	}
	if err := sw.WriteFieldEnd(); err != nil {
		return err
	...
	if err := v.EnumField.Encode(sw); err != nil {
		return err
	}
	if err := sw.WriteFieldEnd(); err != nil {
		return err
	...
	if err := v.LongField.Encode(sw); err != nil {
		return err
	}
	if err := sw.WriteFieldEnd(); err != nil {
		return err
...
func _Fruit_Decode(sr stream.Reader) (Fruit, error) {
	var v Fruit
	err := v.Decode(sr)
	return v, err
}

func _Long_Decode(sr stream.Reader) (Long, error) {
	var x Long
	err := x.Decode(sr)
	return x, err
}

// Decode deserializes a BarRequest struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a BarRequest struct could not be generated from the wire
// representation.
func (v *BarRequest) Decode(sr stream.Reader) error {
	...
	for ok {
		...
		case fh.ID == 4 && fh.Type == wire.TI64:
			v.Timestamp, err = _Timestamp_Decode(sr)
			if err != nil {
				return err
			}
			timestampIsSet = true
		case fh.ID == 5 && fh.Type == wire.TI32:
			v.EnumField, err = _Fruit_Decode(sr)
			if err != nil {
				return err
			}
			enumFieldIsSet = true
		case fh.ID == 6 && fh.Type == wire.TI64:
			v.LongField, err = _Long_Decode(sr)
			if err != nil {
				return err
			}
			longFieldIsSet = true
...
// Encode serializes a BarRequestRecur struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a BarRequestRecur struct could not be encoded.
func (v *BarRequestRecur) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
	...
	if v.Recur != nil {
		...
		if err := v.Recur.Encode(sw); err != nil {
			return err
		}
		if err := sw.WriteFieldEnd(); err != nil {
			return err
...
func _BarRequestRecur_Decode(sr stream.Reader) (*BarRequestRecur, error) {
	var v BarRequestRecur
	err := v.Decode(sr)
	return &v, err
}

// Decode deserializes a BarRequestRecur struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a BarRequestRecur struct could not be generated from the wire
// representation.
func (v *BarRequestRecur) Decode(sr stream.Reader) error {
	...
	for ok {
		...
		case fh.ID == 2 && fh.Type == wire.TStruct:
			v.Recur, err = _BarRequestRecur_Decode(sr)
			if err != nil {
				return err
			}
...
func _Map_UUID_I32_Encode(val map[UUID]int32, sw stream.Writer) error {
...
// Encode serializes a BarResponse struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a BarResponse struct could not be encoded.
func (v *BarResponse) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
	...
	if err := sw.WriteInt32(v.IntWithRange); err != nil {
		return err
	}
	if err := sw.WriteFieldEnd(); err != nil {
		return err
	...
	if err := sw.WriteInt32(v.IntWithoutRange); err != nil {
		return err
	}
	if err := sw.WriteFieldEnd(); err != nil {
		return err
	...
	if err := _Map_UUID_I32_Encode(v.MapIntWithRange, sw); err != nil {
		return err
	}
	if err := sw.WriteFieldEnd(); err != nil {
		return err
	...
	if err := _Map_String_I32_Encode(v.MapIntWithoutRange, sw); err != nil {
		return err
	}
	if err := sw.WriteFieldEnd(); err != nil {
		return err
	...
	if v.NextResponse != nil {
		...
		if err := v.NextResponse.Encode(sw); err != nil {
			return err
		}
		if err := sw.WriteFieldEnd(); err != nil {
			return err
...
func _Map_UUID_I32_Decode(sr stream.Reader) (map[UUID]int32, error) {
	...
	o := make(map[UUID]int32, mh.Length)
	for i := 0; i < mh.Length; i++ {
...
func _BarResponse_Decode(sr stream.Reader) (*BarResponse, error) {
	var v BarResponse
	err := v.Decode(sr)
	return &v, err
}

// Decode deserializes a BarResponse struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a BarResponse struct could not be generated from the wire
// representation.
func (v *BarResponse) Decode(sr stream.Reader) error {
	...
	for ok {
		...
		case fh.ID == 2 && fh.Type == wire.TI32:
			v.IntWithRange, err = sr.ReadInt32()
			if err != nil {
				return err
			}
			intWithRangeIsSet = true
		case fh.ID == 3 && fh.Type == wire.TI32:
			v.IntWithoutRange, err = sr.ReadInt32()
			if err != nil {
				return err
			}
			intWithoutRangeIsSet = true
		case fh.ID == 4 && fh.Type == wire.TMap:
			v.MapIntWithRange, err = _Map_UUID_I32_Decode(sr)
			if err != nil {
				return err
			}
			mapIntWithRangeIsSet = true
		case fh.ID == 5 && fh.Type == wire.TMap:
			v.MapIntWithoutRange, err = _Map_String_I32_Decode(sr)
			if err != nil {
				return err
			}
			mapIntWithoutRangeIsSet = true
		...
		case fh.ID == 7 && fh.Type == wire.TStruct:
			v.NextResponse, err = _BarResponse_Decode(sr)
			if err != nil {
				return err
			}
...
// Encode serializes a BarResponseRecur struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a BarResponseRecur struct could not be encoded.
func (v *BarResponseRecur) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
	...
	if err := _List_String_Encode(v.Nodes, sw); err != nil {
		return err
	}
	if err := sw.WriteFieldEnd(); err != nil {
		return err
	...
	if err := sw.WriteInt32(v.Height); err != nil {
		return err
	}
	if err := sw.WriteFieldEnd(); err != nil {
		return err
...
// Decode deserializes a BarResponseRecur struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a BarResponseRecur struct could not be generated from the wire
// representation.
func (v *BarResponseRecur) Decode(sr stream.Reader) error {
	...
	for ok {
		...
		case fh.ID == 1 && fh.Type == wire.TList:
			v.Nodes, err = _List_String_Decode(sr)
			if err != nil {
				return err
			}
			nodesIsSet = true
		case fh.ID == 2 && fh.Type == wire.TI32:
			v.Height, err = sr.ReadInt32()
			if err != nil {
				return err
			}
			heightIsSet = true
...
// Encode encodes DemoType directly to bytes.
//
//   sWriter := BinaryStreamer.Writer(writer)
//
//   var v DemoType
//   return v.Encode(sWriter)
func (v DemoType) Encode(sw stream.Writer) error {
...
// Decode reads off the encoded DemoType directly off of the wire.
//
...
//   }
//   return v, nil
func (v *DemoType) Decode(sr stream.Reader) error {
	i, err := sr.ReadInt32()
	if err != nil {
		return err
	}
...
func (v Long) Encode(sw stream.Writer) error {
	x := (int64)(v)
...
// Decode deserializes Long directly off the wire.
func (v *Long) Decode(sr stream.Reader) error {
	x, err := sr.ReadInt64()
	*v = (Long)(x)
	return err
}
...
// Encode serializes a OptionalParamsStruct struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a OptionalParamsStruct struct could not be encoded.
func (v *OptionalParamsStruct) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
	...
	if v.UserID != nil {
		...
		if err := sw.WriteString(*(v.UserID)); err != nil {
			return err
		}
		if err := sw.WriteFieldEnd(); err != nil {
			return err
...
// Decode deserializes a OptionalParamsStruct struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a OptionalParamsStruct struct could not be generated from the wire
// representation.
func (v *OptionalParamsStruct) Decode(sr stream.Reader) error {
...
// Encode serializes a ParamsStruct struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a ParamsStruct struct could not be encoded.
func (v *ParamsStruct) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
	...
	if err := sw.WriteString(v.UserUUID); err != nil {
		return err
	}
	if err := sw.WriteFieldEnd(); err != nil {
		return err
...
// Decode deserializes a ParamsStruct struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a ParamsStruct struct could not be generated from the wire
// representation.
func (v *ParamsStruct) Decode(sr stream.Reader) error {
...
// Encode serializes a QueryParamsOptsStruct struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a QueryParamsOptsStruct struct could not be encoded.
func (v *QueryParamsOptsStruct) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
	...
	if v.AuthUUID != nil {
		...
		if err := sw.WriteString(*(v.AuthUUID)); err != nil {
			return err
		}
		if err := sw.WriteFieldEnd(); err != nil {
			return err
	...
	if v.AuthUUID2 != nil {
		...
		if err := sw.WriteString(*(v.AuthUUID2)); err != nil {
			return err
		}
		if err := sw.WriteFieldEnd(); err != nil {
			return err
...
// Decode deserializes a QueryParamsOptsStruct struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a QueryParamsOptsStruct struct could not be generated from the wire
// representation.
func (v *QueryParamsOptsStruct) Decode(sr stream.Reader) error {
...
// Encode serializes a QueryParamsStruct struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a QueryParamsStruct struct could not be encoded.
func (v *QueryParamsStruct) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
	...
	if err := _List_String_Encode(v.Foo, sw); err != nil {
		return err
	}
	if err := sw.WriteFieldEnd(); err != nil {
		return err
...
// Decode deserializes a QueryParamsStruct struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a QueryParamsStruct struct could not be generated from the wire
// representation.
func (v *QueryParamsStruct) Decode(sr stream.Reader) error {
	...
	for ok {
		...
		case fh.ID == 5 && fh.Type == wire.TList:
			v.Foo, err = _List_String_Decode(sr)
			if err != nil {
				return err
			}
			fooIsSet = true
...
// Encode serializes a RequestWithDuplicateType struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a RequestWithDuplicateType struct could not be encoded.
func (v *RequestWithDuplicateType) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
	...
	if v.Request1 != nil {
		...
		if err := v.Request1.Encode(sw); err != nil {
			return err
		}
		if err := sw.WriteFieldEnd(); err != nil {
			return err
	...
	if v.Request2 != nil {
		...
		if err := v.Request2.Encode(sw); err != nil {
			return err
		}
		if err := sw.WriteFieldEnd(); err != nil {
			return err
...
func _BarRequest_Decode(sr stream.Reader) (*BarRequest, error) {
	var v BarRequest
	err := v.Decode(sr)
	return &v, err
}

// Decode deserializes a RequestWithDuplicateType struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a RequestWithDuplicateType struct could not be generated from the wire
// representation.
func (v *RequestWithDuplicateType) Decode(sr stream.Reader) error {
	...
	for ok {
		...
		case fh.ID == 1 && fh.Type == wire.TStruct:
			v.Request1, err = _BarRequest_Decode(sr)
			if err != nil {
				return err
			}

		case fh.ID == 2 && fh.Type == wire.TStruct:
			v.Request2, err = _BarRequest_Decode(sr)
			if err != nil {
				return err
			}
...
// Encode serializes a SeeOthersRedirection struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a SeeOthersRedirection struct could not be encoded.
func (v *SeeOthersRedirection) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a SeeOthersRedirection struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a SeeOthersRedirection struct could not be generated from the wire
// representation.
func (v *SeeOthersRedirection) Decode(sr stream.Reader) error {
...
func _List_UUID_Encode(val []UUID, sw stream.Writer) error {
...
func _List_UUID_Decode(sr stream.Reader) ([]UUID, error) {
	lh, err := sr.ReadListBegin()
	if err != nil {
		return nil, err
	}
...
func (v UUIDList) Encode(sw stream.Writer) error {
	x := ([]UUID)(v)
	return _List_UUID_Encode(x, sw)
}
...
// Decode deserializes UUIDList directly off the wire.
func (v *UUIDList) Decode(sr stream.Reader) error {
	x, err := _List_UUID_Decode(sr)
	*v = (UUIDList)(x)
	return err
}
...
// Encode serializes a Bar_ArgNotStruct_Args struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Bar_ArgNotStruct_Args struct could not be encoded.
func (v *Bar_ArgNotStruct_Args) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
	...
	if err := sw.WriteString(v.Request); err != nil {
		return err
	}
	if err := sw.WriteFieldEnd(); err != nil {
		return err
...
// Decode deserializes a Bar_ArgNotStruct_Args struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Bar_ArgNotStruct_Args struct could not be generated from the wire
// representation.
func (v *Bar_ArgNotStruct_Args) Decode(sr stream.Reader) error {
...
// Encode serializes a Bar_ArgNotStruct_Result struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Bar_ArgNotStruct_Result struct could not be encoded.
func (v *Bar_ArgNotStruct_Result) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
	...
	if v.BarException != nil {
		...
		if err := v.BarException.Encode(sw); err != nil {
			return err
		}
		if err := sw.WriteFieldEnd(); err != nil {
			return err
...
func _BarException_Decode(sr stream.Reader) (*BarException, error) {
	var v BarException
	err := v.Decode(sr)
	return &v, err
}

// Decode deserializes a Bar_ArgNotStruct_Result struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Bar_ArgNotStruct_Result struct could not be generated from the wire
// representation.
func (v *Bar_ArgNotStruct_Result) Decode(sr stream.Reader) error {
	...
	for ok {
		switch {
		case fh.ID == 1 && fh.Type == wire.TStruct:
			v.BarException, err = _BarException_Decode(sr)
			if err != nil {
				return err
			}
...
// Encode serializes a Bar_ArgWithHeaders_Args struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Bar_ArgWithHeaders_Args struct could not be encoded.
func (v *Bar_ArgWithHeaders_Args) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
	...
	if v.ParamsStruct != nil {
		...
		if err := v.ParamsStruct.Encode(sw); err != nil {
			return err
		}
		if err := sw.WriteFieldEnd(); err != nil {
			return err
...
func _OptionalParamsStruct_Decode(sr stream.Reader) (*OptionalParamsStruct, error) {
	var v OptionalParamsStruct
	err := v.Decode(sr)
	return &v, err
}

// Decode deserializes a Bar_ArgWithHeaders_Args struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Bar_ArgWithHeaders_Args struct could not be generated from the wire
// representation.
func (v *Bar_ArgWithHeaders_Args) Decode(sr stream.Reader) error {
	...
	for ok {
		...
		case fh.ID == 3 && fh.Type == wire.TStruct:
			v.ParamsStruct, err = _OptionalParamsStruct_Decode(sr)
			if err != nil {
				return err
			}
...
// Encode serializes a Bar_ArgWithHeaders_Result struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Bar_ArgWithHeaders_Result struct could not be encoded.
func (v *Bar_ArgWithHeaders_Result) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a Bar_ArgWithHeaders_Result struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Bar_ArgWithHeaders_Result struct could not be generated from the wire
// representation.
func (v *Bar_ArgWithHeaders_Result) Decode(sr stream.Reader) error {
	...
	for ok {
		...
		case fh.ID == 0 && fh.Type == wire.TStruct:
			v.Success, err = _BarResponse_Decode(sr)
			if err != nil {
				return err
			}
...
func _List_Fruit_Encode(val []Fruit, sw stream.Writer) error {
...
func _List_DemoType_Encode(val []DemoType, sw stream.Writer) error {
...
// Encode serializes a Bar_ArgWithManyQueryParams_Args struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Bar_ArgWithManyQueryParams_Args struct could not be encoded.
func (v *Bar_ArgWithManyQueryParams_Args) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
	...
	if err := sw.WriteString(v.AStr); err != nil {
		return err
	}
	if err := sw.WriteFieldEnd(); err != nil {
		return err
	...
	if v.AnOptStr != nil {
		...
		if err := sw.WriteString(*(v.AnOptStr)); err != nil {
			return err
		}
		if err := sw.WriteFieldEnd(); err != nil {
			return err
	...
	if err := sw.WriteBool(v.ABool); err != nil {
		return err
	}
	if err := sw.WriteFieldEnd(); err != nil {
		return err
	...
	if v.AnOptBool != nil {
		...
		if err := sw.WriteBool(*(v.AnOptBool)); err != nil {
			return err
		}
		if err := sw.WriteFieldEnd(); err != nil {
			return err
	...
	if err := sw.WriteFieldBegin(stream.FieldHeader{ID: 5, Type: wire.TI8}); err != nil {
		return err
	}
	if err := sw.WriteInt8(v.AInt8); err != nil {
		return err
	}
	if err := sw.WriteFieldEnd(); err != nil {
		return err
	...
	if v.AnOptInt8 != nil {
		...
		if err := sw.WriteInt8(*(v.AnOptInt8)); err != nil {
			return err
		}
		if err := sw.WriteFieldEnd(); err != nil {
			return err
	...
	if err := sw.WriteFieldBegin(stream.FieldHeader{ID: 7, Type: wire.TI16}); err != nil {
		return err
	}
	if err := sw.WriteInt16(v.AInt16); err != nil {
		return err
	}
	if err := sw.WriteFieldEnd(); err != nil {
		return err
	...
	if v.AnOptInt16 != nil {
		if err := sw.WriteFieldBegin(stream.FieldHeader{ID: 8, Type: wire.TI16}); err != nil {
			return err
		}
		if err := sw.WriteInt16(*(v.AnOptInt16)); err != nil {
			return err
		}
		if err := sw.WriteFieldEnd(); err != nil {
			return err
	...
	if err := sw.WriteInt32(v.AInt32); err != nil {
		return err
	}
	if err := sw.WriteFieldEnd(); err != nil {
		return err
	...
	if v.AnOptInt32 != nil {
		...
		if err := sw.WriteInt32(*(v.AnOptInt32)); err != nil {
			return err
		}
		if err := sw.WriteFieldEnd(); err != nil {
			return err
	...
	if err := sw.WriteInt64(v.AInt64); err != nil {
		return err
	}
	if err := sw.WriteFieldEnd(); err != nil {
		return err
	...
	if v.AnOptInt64 != nil {
		...
		if err := sw.WriteInt64(*(v.AnOptInt64)); err != nil {
			return err
		}
		if err := sw.WriteFieldEnd(); err != nil {
			return err
	...
	if err := sw.WriteFieldBegin(stream.FieldHeader{ID: 13, Type: wire.TDouble}); err != nil {
		return err
	}
	if err := sw.WriteDouble(v.AFloat64); err != nil {
		return err
	}
	if err := sw.WriteFieldEnd(); err != nil {
		return err
	...
	if v.AnOptFloat64 != nil {
		if err := sw.WriteFieldBegin(stream.FieldHeader{ID: 14, Type: wire.TDouble}); err != nil {
			return err
		}
		if err := sw.WriteDouble(*(v.AnOptFloat64)); err != nil {
			return err
		}
		if err := sw.WriteFieldEnd(); err != nil {
			return err
	...
	if err := v.AUUID.Encode(sw); err != nil {
		return err
	}
	if err := sw.WriteFieldEnd(); err != nil {
		return err
	...
	if v.AnOptUUID != nil {
		...
		if err := v.AnOptUUID.Encode(sw); err != nil {
			return err
		}
		if err := sw.WriteFieldEnd(); err != nil {
			return err
	...
	if err := sw.WriteFieldBegin(stream.FieldHeader{ID: 17, Type: wire.TList}); err != nil {
		return err
	}
	if err := _List_UUID_Encode(v.AListUUID, sw); err != nil {
		return err
	}
	if err := sw.WriteFieldEnd(); err != nil {
		return err
	...
	if v.AnOptListUUID != nil {
		if err := sw.WriteFieldBegin(stream.FieldHeader{ID: 18, Type: wire.TList}); err != nil {
			return err
		}
		if err := _List_UUID_Encode(v.AnOptListUUID, sw); err != nil {
			return err
		}
		if err := sw.WriteFieldEnd(); err != nil {
			return err
	...
	if err := sw.WriteFieldBegin(stream.FieldHeader{ID: 19, Type: wire.TList}); err != nil {
		return err
	}
	if err := v.AStringList.Encode(sw); err != nil {
		return err
	}
	if err := sw.WriteFieldEnd(); err != nil {
		return err
	...
	if v.AnOptStringList != nil {
		...
		if err := v.AnOptStringList.Encode(sw); err != nil {
			return err
		}
		if err := sw.WriteFieldEnd(); err != nil {
			return err
	...
	if err := sw.WriteFieldBegin(stream.FieldHeader{ID: 21, Type: wire.TList}); err != nil {
		return err
	}
	if err := v.AUUIDList.Encode(sw); err != nil {
		return err
	}
	if err := sw.WriteFieldEnd(); err != nil {
		return err
	...
	if v.AnOptUUIDList != nil {
		if err := sw.WriteFieldBegin(stream.FieldHeader{ID: 22, Type: wire.TList}); err != nil {
			return err
		}
		if err := v.AnOptUUIDList.Encode(sw); err != nil {
			return err
		}
		if err := sw.WriteFieldEnd(); err != nil {
			return err
	...
	if err := v.ATs.Encode(sw); err != nil {
		return err
	}
	if err := sw.WriteFieldEnd(); err != nil {
		return err
	...
	if v.AnOptTs != nil {
		...
		if err := v.AnOptTs.Encode(sw); err != nil {
			return err
		}
		if err := sw.WriteFieldEnd(); err != nil {
			return err
	...
	if err := v.AReqDemo.Encode(sw); err != nil {
		return err
	}
	if err := sw.WriteFieldEnd(); err != nil {
		return err
	...
	if v.AnOptFruit != nil {
		...
		if err := v.AnOptFruit.Encode(sw); err != nil {
			return err
		}
		if err := sw.WriteFieldEnd(); err != nil {
			return err
	...
	if err := sw.WriteFieldBegin(stream.FieldHeader{ID: 27, Type: wire.TList}); err != nil {
		return err
	}
	if err := _List_Fruit_Encode(v.AReqFruits, sw); err != nil {
		return err
	}
	if err := sw.WriteFieldEnd(); err != nil {
		return err
	...
	if v.AnOptDemos != nil {
		if err := sw.WriteFieldBegin(stream.FieldHeader{ID: 28, Type: wire.TList}); err != nil {
			return err
		}
		if err := _List_DemoType_Encode(v.AnOptDemos, sw); err != nil {
			return err
		}
		if err := sw.WriteFieldEnd(); err != nil {
			return err
...
func _UUIDList_Decode(sr stream.Reader) (UUIDList, error) {
	var x UUIDList
	err := x.Decode(sr)
	return x, err
}

func _DemoType_Decode(sr stream.Reader) (DemoType, error) {
	var v DemoType
	err := v.Decode(sr)
	return v, err
}

func _List_Fruit_Decode(sr stream.Reader) ([]Fruit, error) {
	lh, err := sr.ReadListBegin()
	if err != nil {
		return nil, err
	}
	...
	o := make([]Fruit, 0, lh.Length)
	for i := 0; i < lh.Length; i++ {
		v, err := _Fruit_Decode(sr)
		if err != nil {
			return nil, err
		}
		o = append(o, v)
...
func _List_DemoType_Decode(sr stream.Reader) ([]DemoType, error) {
	lh, err := sr.ReadListBegin()
	if err != nil {
		return nil, err
	}
	...
	o := make([]DemoType, 0, lh.Length)
	for i := 0; i < lh.Length; i++ {
		v, err := _DemoType_Decode(sr)
		if err != nil {
			return nil, err
		}
		o = append(o, v)
...
// Decode deserializes a Bar_ArgWithManyQueryParams_Args struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Bar_ArgWithManyQueryParams_Args struct could not be generated from the wire
// representation.
func (v *Bar_ArgWithManyQueryParams_Args) Decode(sr stream.Reader) error {
	...
	for ok {
		...
		case fh.ID == 5 && fh.Type == wire.TI8:
			v.AInt8, err = sr.ReadInt8()
			if err != nil {
				return err
			}
			aInt8IsSet = true
		...
		case fh.ID == 7 && fh.Type == wire.TI16:
			v.AInt16, err = sr.ReadInt16()
			if err != nil {
				return err
			}
			aInt16IsSet = true
		case fh.ID == 8 && fh.Type == wire.TI16:
			var x int16
			x, err = sr.ReadInt16()
			v.AnOptInt16 = &x
			if err != nil {
		...
		case fh.ID == 13 && fh.Type == wire.TDouble:
			v.AFloat64, err = sr.ReadDouble()
			if err != nil {
				return err
			}
			aFloat64IsSet = true
		case fh.ID == 14 && fh.Type == wire.TDouble:
			var x float64
			x, err = sr.ReadDouble()
			v.AnOptFloat64 = &x
			if err != nil {
		...
		case fh.ID == 17 && fh.Type == wire.TList:
			v.AListUUID, err = _List_UUID_Decode(sr)
			if err != nil {
				return err
			}
			aListUUIDIsSet = true
		case fh.ID == 18 && fh.Type == wire.TList:
			v.AnOptListUUID, err = _List_UUID_Decode(sr)
			if err != nil {
				return err
			}

		case fh.ID == 19 && fh.Type == wire.TList:
			v.AStringList, err = _StringList_Decode(sr)
			if err != nil {
				return err
			}
			aStringListIsSet = true
		case fh.ID == 20 && fh.Type == wire.TList:
			v.AnOptStringList, err = _StringList_Decode(sr)
			if err != nil {
				return err
			}

		case fh.ID == 21 && fh.Type == wire.TList:
			v.AUUIDList, err = _UUIDList_Decode(sr)
			if err != nil {
				return err
			}
			aUUIDListIsSet = true
		case fh.ID == 22 && fh.Type == wire.TList:
			v.AnOptUUIDList, err = _UUIDList_Decode(sr)
			if err != nil {
				return err
			}

		case fh.ID == 23 && fh.Type == wire.TI64:
			v.ATs, err = _Timestamp_Decode(sr)
			if err != nil {
				return err
			}
			aTsIsSet = true
		...
		case fh.ID == 25 && fh.Type == wire.TI32:
			v.AReqDemo, err = _DemoType_Decode(sr)
			if err != nil {
				return err
			}
			aReqDemoIsSet = true
		case fh.ID == 26 && fh.Type == wire.TI32:
			var x Fruit
			x, err = _Fruit_Decode(sr)
			v.AnOptFruit = &x
			if err != nil {
				return err
			}

		case fh.ID == 27 && fh.Type == wire.TList:
			v.AReqFruits, err = _List_Fruit_Decode(sr)
			if err != nil {
				return err
			}
			aReqFruitsIsSet = true
		case fh.ID == 28 && fh.Type == wire.TList:
			v.AnOptDemos, err = _List_DemoType_Decode(sr)
			if err != nil {
				return err
			}
...
func (v *Bar_ArgWithManyQueryParams_Args) MarshalLogObject(enc zapcore.ObjectEncoder) (err error) {
	...
	err = multierr.Append(err, enc.AddArray("aStringList", (_List_String_Zapper)(v.AStringList)))
	if v.AnOptStringList != nil {
		err = multierr.Append(err, enc.AddArray("anOptStringList", (_List_String_Zapper)(v.AnOptStringList)))
	}
	err = multierr.Append(err, enc.AddArray("aUUIDList", (_List_UUID_Zapper)(v.AUUIDList)))
	if v.AnOptUUIDList != nil {
		err = multierr.Append(err, enc.AddArray("anOptUUIDList", (_List_UUID_Zapper)(v.AnOptUUIDList)))
	}
...
// Encode serializes a Bar_ArgWithManyQueryParams_Result struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Bar_ArgWithManyQueryParams_Result struct could not be encoded.
func (v *Bar_ArgWithManyQueryParams_Result) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a Bar_ArgWithManyQueryParams_Result struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Bar_ArgWithManyQueryParams_Result struct could not be generated from the wire
// representation.
func (v *Bar_ArgWithManyQueryParams_Result) Decode(sr stream.Reader) error {
...
// Encode serializes a Bar_ArgWithNearDupQueryParams_Args struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Bar_ArgWithNearDupQueryParams_Args struct could not be encoded.
func (v *Bar_ArgWithNearDupQueryParams_Args) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
	...
	if err := sw.WriteString(v.One); err != nil {
		return err
	}
	if err := sw.WriteFieldEnd(); err != nil {
		return err
	...
	if v.Two != nil {
		...
		if err := sw.WriteInt32(*(v.Two)); err != nil {
			return err
		}
		if err := sw.WriteFieldEnd(); err != nil {
			return err
	...
	if v.Three != nil {
		...
		if err := sw.WriteString(*(v.Three)); err != nil {
			return err
		}
		if err := sw.WriteFieldEnd(); err != nil {
			return err
	...
	if v.Four != nil {
		...
		if err := sw.WriteString(*(v.Four)); err != nil {
			return err
		}
		if err := sw.WriteFieldEnd(); err != nil {
			return err
...
// Decode deserializes a Bar_ArgWithNearDupQueryParams_Args struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Bar_ArgWithNearDupQueryParams_Args struct could not be generated from the wire
// representation.
func (v *Bar_ArgWithNearDupQueryParams_Args) Decode(sr stream.Reader) error {
...
// Encode serializes a Bar_ArgWithNearDupQueryParams_Result struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Bar_ArgWithNearDupQueryParams_Result struct could not be encoded.
func (v *Bar_ArgWithNearDupQueryParams_Result) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a Bar_ArgWithNearDupQueryParams_Result struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Bar_ArgWithNearDupQueryParams_Result struct could not be generated from the wire
// representation.
func (v *Bar_ArgWithNearDupQueryParams_Result) Decode(sr stream.Reader) error {
...
// Encode serializes a Bar_ArgWithNestedQueryParams_Args struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Bar_ArgWithNestedQueryParams_Args struct could not be encoded.
func (v *Bar_ArgWithNestedQueryParams_Args) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
	...
	if v.Opt != nil {
		...
		if err := v.Opt.Encode(sw); err != nil {
			return err
		}
		if err := sw.WriteFieldEnd(); err != nil {
			return err
...
func _QueryParamsStruct_Decode(sr stream.Reader) (*QueryParamsStruct, error) {
	var v QueryParamsStruct
	err := v.Decode(sr)
	return &v, err
}

func _QueryParamsOptsStruct_Decode(sr stream.Reader) (*QueryParamsOptsStruct, error) {
	var v QueryParamsOptsStruct
	err := v.Decode(sr)
	return &v, err
}

// Decode deserializes a Bar_ArgWithNestedQueryParams_Args struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Bar_ArgWithNestedQueryParams_Args struct could not be generated from the wire
// representation.
func (v *Bar_ArgWithNestedQueryParams_Args) Decode(sr stream.Reader) error {
	...
	for ok {
		switch {
		case fh.ID == 1 && fh.Type == wire.TStruct:
			v.Request, err = _QueryParamsStruct_Decode(sr)
			if err != nil {
				return err
			}
			requestIsSet = true
		case fh.ID == 2 && fh.Type == wire.TStruct:
			v.Opt, err = _QueryParamsOptsStruct_Decode(sr)
			if err != nil {
				return err
			}
...
// Encode serializes a Bar_ArgWithNestedQueryParams_Result struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Bar_ArgWithNestedQueryParams_Result struct could not be encoded.
func (v *Bar_ArgWithNestedQueryParams_Result) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a Bar_ArgWithNestedQueryParams_Result struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Bar_ArgWithNestedQueryParams_Result struct could not be generated from the wire
// representation.
func (v *Bar_ArgWithNestedQueryParams_Result) Decode(sr stream.Reader) error {
...
// Encode serializes a Bar_ArgWithParams_Args struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Bar_ArgWithParams_Args struct could not be encoded.
func (v *Bar_ArgWithParams_Args) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
	...
	if v.Params != nil {
		...
		if err := v.Params.Encode(sw); err != nil {
			return err
		}
		if err := sw.WriteFieldEnd(); err != nil {
			return err
...
func _ParamsStruct_Decode(sr stream.Reader) (*ParamsStruct, error) {
	var v ParamsStruct
	err := v.Decode(sr)
	return &v, err
}

// Decode deserializes a Bar_ArgWithParams_Args struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Bar_ArgWithParams_Args struct could not be generated from the wire
// representation.
func (v *Bar_ArgWithParams_Args) Decode(sr stream.Reader) error {
	...
	for ok {
		...
		case fh.ID == 1 && fh.Type == wire.TBinary:
			...
			uuidIsSet = true
		case fh.ID == 2 && fh.Type == wire.TStruct:
			v.Params, err = _ParamsStruct_Decode(sr)
			if err != nil {
				return err
			}
...
// Encode serializes a Bar_ArgWithParams_Result struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Bar_ArgWithParams_Result struct could not be encoded.
func (v *Bar_ArgWithParams_Result) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a Bar_ArgWithParams_Result struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Bar_ArgWithParams_Result struct could not be generated from the wire
// representation.
func (v *Bar_ArgWithParams_Result) Decode(sr stream.Reader) error {
...
// Encode serializes a Bar_ArgWithParamsAndDuplicateFields_Args struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Bar_ArgWithParamsAndDuplicateFields_Args struct could not be encoded.
func (v *Bar_ArgWithParamsAndDuplicateFields_Args) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
	...
	if err := sw.WriteString(v.EntityUUID); err != nil {
		return err
	}
	if err := sw.WriteFieldEnd(); err != nil {
		return err
...
func _RequestWithDuplicateType_Decode(sr stream.Reader) (*RequestWithDuplicateType, error) {
	var v RequestWithDuplicateType
	err := v.Decode(sr)
	return &v, err
}

// Decode deserializes a Bar_ArgWithParamsAndDuplicateFields_Args struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Bar_ArgWithParamsAndDuplicateFields_Args struct could not be generated from the wire
// representation.
func (v *Bar_ArgWithParamsAndDuplicateFields_Args) Decode(sr stream.Reader) error {
	...
	for ok {
		switch {
		case fh.ID == 1 && fh.Type == wire.TStruct:
			v.Request, err = _RequestWithDuplicateType_Decode(sr)
			if err != nil {
				return err
			}
			requestIsSet = true
		case fh.ID == 2 && fh.Type == wire.TBinary:
			v.EntityUUID, err = sr.ReadString()
			if err != nil {
				return err
			}
			entityUUIDIsSet = true
...
// Encode serializes a Bar_ArgWithParamsAndDuplicateFields_Result struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Bar_ArgWithParamsAndDuplicateFields_Result struct could not be encoded.
func (v *Bar_ArgWithParamsAndDuplicateFields_Result) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a Bar_ArgWithParamsAndDuplicateFields_Result struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Bar_ArgWithParamsAndDuplicateFields_Result struct could not be generated from the wire
// representation.
func (v *Bar_ArgWithParamsAndDuplicateFields_Result) Decode(sr stream.Reader) error {
...
// Encode serializes a Bar_ArgWithQueryHeader_Args struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Bar_ArgWithQueryHeader_Args struct could not be encoded.
func (v *Bar_ArgWithQueryHeader_Args) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a Bar_ArgWithQueryHeader_Args struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Bar_ArgWithQueryHeader_Args struct could not be generated from the wire
// representation.
func (v *Bar_ArgWithQueryHeader_Args) Decode(sr stream.Reader) error {
...
// Encode serializes a Bar_ArgWithQueryHeader_Result struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Bar_ArgWithQueryHeader_Result struct could not be encoded.
func (v *Bar_ArgWithQueryHeader_Result) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a Bar_ArgWithQueryHeader_Result struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Bar_ArgWithQueryHeader_Result struct could not be generated from the wire
// representation.
func (v *Bar_ArgWithQueryHeader_Result) Decode(sr stream.Reader) error {
...
func _List_Byte_Encode(val []int8, sw stream.Writer) error {
...
// Encode serializes a Bar_ArgWithQueryParams_Args struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Bar_ArgWithQueryParams_Args struct could not be encoded.
func (v *Bar_ArgWithQueryParams_Args) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
	...
	if err := _List_Byte_Encode(v.Bar, sw); err != nil {
		return err
	}
	if err := sw.WriteFieldEnd(); err != nil {
		return err
...
func _List_Byte_Decode(sr stream.Reader) ([]int8, error) {
	lh, err := sr.ReadListBegin()
	if err != nil {
		return nil, err
	}
...
// Decode deserializes a Bar_ArgWithQueryParams_Args struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Bar_ArgWithQueryParams_Args struct could not be generated from the wire
// representation.
func (v *Bar_ArgWithQueryParams_Args) Decode(sr stream.Reader) error {
	...
	for ok {
		...
		case fh.ID == 4 && fh.Type == wire.TList:
			v.Bar, err = _List_Byte_Decode(sr)
			if err != nil {
				return err
			}
			barIsSet = true
...
// Encode serializes a Bar_ArgWithQueryParams_Result struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Bar_ArgWithQueryParams_Result struct could not be encoded.
func (v *Bar_ArgWithQueryParams_Result) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a Bar_ArgWithQueryParams_Result struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Bar_ArgWithQueryParams_Result struct could not be generated from the wire
// representation.
func (v *Bar_ArgWithQueryParams_Result) Decode(sr stream.Reader) error {
...
// Encode serializes a Bar_DeleteFoo_Args struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Bar_DeleteFoo_Args struct could not be encoded.
func (v *Bar_DeleteFoo_Args) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a Bar_DeleteFoo_Args struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Bar_DeleteFoo_Args struct could not be generated from the wire
// representation.
func (v *Bar_DeleteFoo_Args) Decode(sr stream.Reader) error {
...
// Encode serializes a Bar_DeleteFoo_Result struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Bar_DeleteFoo_Result struct could not be encoded.
func (v *Bar_DeleteFoo_Result) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a Bar_DeleteFoo_Result struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Bar_DeleteFoo_Result struct could not be generated from the wire
// representation.
func (v *Bar_DeleteFoo_Result) Decode(sr stream.Reader) error {
...
// Encode serializes a Bar_DeleteWithBody_Args struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Bar_DeleteWithBody_Args struct could not be encoded.
func (v *Bar_DeleteWithBody_Args) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
	...
	if err := sw.WriteString(v.Filter); err != nil {
		return err
	}
	if err := sw.WriteFieldEnd(); err != nil {
		return err
	...
	if v.Count != nil {
		...
		if err := sw.WriteInt32(*(v.Count)); err != nil {
			return err
		}
		if err := sw.WriteFieldEnd(); err != nil {
			return err
...
// Decode deserializes a Bar_DeleteWithBody_Args struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Bar_DeleteWithBody_Args struct could not be generated from the wire
// representation.
func (v *Bar_DeleteWithBody_Args) Decode(sr stream.Reader) error {
...
// Encode serializes a Bar_DeleteWithBody_Result struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Bar_DeleteWithBody_Result struct could not be encoded.
func (v *Bar_DeleteWithBody_Result) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a Bar_DeleteWithBody_Result struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Bar_DeleteWithBody_Result struct could not be generated from the wire
// representation.
func (v *Bar_DeleteWithBody_Result) Decode(sr stream.Reader) error {
...
// Encode serializes a Bar_DeleteWithQueryParams_Args struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Bar_DeleteWithQueryParams_Args struct could not be encoded.
func (v *Bar_DeleteWithQueryParams_Args) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a Bar_DeleteWithQueryParams_Args struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Bar_DeleteWithQueryParams_Args struct could not be generated from the wire
// representation.
func (v *Bar_DeleteWithQueryParams_Args) Decode(sr stream.Reader) error {
...
// Encode serializes a Bar_DeleteWithQueryParams_Result struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Bar_DeleteWithQueryParams_Result struct could not be encoded.
func (v *Bar_DeleteWithQueryParams_Result) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a Bar_DeleteWithQueryParams_Result struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Bar_DeleteWithQueryParams_Result struct could not be generated from the wire
// representation.
func (v *Bar_DeleteWithQueryParams_Result) Decode(sr stream.Reader) error {
...
// Encode serializes a Bar_HelloWorld_Args struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Bar_HelloWorld_Args struct could not be encoded.
func (v *Bar_HelloWorld_Args) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a Bar_HelloWorld_Args struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Bar_HelloWorld_Args struct could not be generated from the wire
// representation.
func (v *Bar_HelloWorld_Args) Decode(sr stream.Reader) error {
...
// Encode serializes a Bar_HelloWorld_Result struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Bar_HelloWorld_Result struct could not be encoded.
func (v *Bar_HelloWorld_Result) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
	...
	if v.SeeOthersRedirection != nil {
		...
		if err := v.SeeOthersRedirection.Encode(sw); err != nil {
			return err
		}
		if err := sw.WriteFieldEnd(); err != nil {
			return err
...
func _SeeOthersRedirection_Decode(sr stream.Reader) (*SeeOthersRedirection, error) {
	var v SeeOthersRedirection
	err := v.Decode(sr)
	return &v, err
}

// Decode deserializes a Bar_HelloWorld_Result struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Bar_HelloWorld_Result struct could not be generated from the wire
// representation.
func (v *Bar_HelloWorld_Result) Decode(sr stream.Reader) error {
	...
	for ok {
		...
		case fh.ID == 2 && fh.Type == wire.TStruct:
			v.SeeOthersRedirection, err = _SeeOthersRedirection_Decode(sr)
			if err != nil {
				return err
			}
...
// Encode serializes a Bar_ListAndEnum_Args struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Bar_ListAndEnum_Args struct could not be encoded.
func (v *Bar_ListAndEnum_Args) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
	...
	if err := _List_String_Encode(v.DemoIds, sw); err != nil {
		return err
	}
	if err := sw.WriteFieldEnd(); err != nil {
		return err
	...
	if v.DemoType != nil {
		...
		if err := v.DemoType.Encode(sw); err != nil {
			return err
		}
		if err := sw.WriteFieldEnd(); err != nil {
			return err
	...
	if v.Demos != nil {
		...
		if err := _List_DemoType_Encode(v.Demos, sw); err != nil {
			return err
		}
		if err := sw.WriteFieldEnd(); err != nil {
			return err
...
// Decode deserializes a Bar_ListAndEnum_Args struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Bar_ListAndEnum_Args struct could not be generated from the wire
// representation.
func (v *Bar_ListAndEnum_Args) Decode(sr stream.Reader) error {
	...
	for ok {
		switch {
		case fh.ID == 1 && fh.Type == wire.TList:
			v.DemoIds, err = _List_String_Decode(sr)
			if err != nil {
				return err
			}
			demoIdsIsSet = true
		...
		case fh.ID == 3 && fh.Type == wire.TList:
			v.Demos, err = _List_DemoType_Decode(sr)
			if err != nil {
				return err
			}
...
// Encode serializes a Bar_ListAndEnum_Result struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Bar_ListAndEnum_Result struct could not be encoded.
func (v *Bar_ListAndEnum_Result) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a Bar_ListAndEnum_Result struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Bar_ListAndEnum_Result struct could not be generated from the wire
// representation.
func (v *Bar_ListAndEnum_Result) Decode(sr stream.Reader) error {
...
// Encode serializes a Bar_MissingArg_Args struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Bar_MissingArg_Args struct could not be encoded.
func (v *Bar_MissingArg_Args) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a Bar_MissingArg_Args struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Bar_MissingArg_Args struct could not be generated from the wire
// representation.
func (v *Bar_MissingArg_Args) Decode(sr stream.Reader) error {
...
// Encode serializes a Bar_MissingArg_Result struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Bar_MissingArg_Result struct could not be encoded.
func (v *Bar_MissingArg_Result) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a Bar_MissingArg_Result struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Bar_MissingArg_Result struct could not be generated from the wire
// representation.
func (v *Bar_MissingArg_Result) Decode(sr stream.Reader) error {
...
// Encode serializes a Bar_NoRequest_Args struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Bar_NoRequest_Args struct could not be encoded.
func (v *Bar_NoRequest_Args) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a Bar_NoRequest_Args struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Bar_NoRequest_Args struct could not be generated from the wire
// representation.
func (v *Bar_NoRequest_Args) Decode(sr stream.Reader) error {
...
// Encode serializes a Bar_NoRequest_Result struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Bar_NoRequest_Result struct could not be encoded.
func (v *Bar_NoRequest_Result) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a Bar_NoRequest_Result struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Bar_NoRequest_Result struct could not be generated from the wire
// representation.
func (v *Bar_NoRequest_Result) Decode(sr stream.Reader) error {
...
// Encode serializes a Bar_Normal_Args struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Bar_Normal_Args struct could not be encoded.
func (v *Bar_Normal_Args) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a Bar_Normal_Args struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Bar_Normal_Args struct could not be generated from the wire
// representation.
func (v *Bar_Normal_Args) Decode(sr stream.Reader) error {
	...
	for ok {
		switch {
		case fh.ID == 1 && fh.Type == wire.TStruct:
			v.Request, err = _BarRequest_Decode(sr)
			if err != nil {
				return err
			}
			requestIsSet = true
...
// Encode serializes a Bar_Normal_Result struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Bar_Normal_Result struct could not be encoded.
func (v *Bar_Normal_Result) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a Bar_Normal_Result struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Bar_Normal_Result struct could not be generated from the wire
// representation.
func (v *Bar_Normal_Result) Decode(sr stream.Reader) error {
...
// Encode serializes a Bar_NormalRecur_Args struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Bar_NormalRecur_Args struct could not be encoded.
func (v *Bar_NormalRecur_Args) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a Bar_NormalRecur_Args struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Bar_NormalRecur_Args struct could not be generated from the wire
// representation.
func (v *Bar_NormalRecur_Args) Decode(sr stream.Reader) error {
	...
	for ok {
		switch {
		case fh.ID == 1 && fh.Type == wire.TStruct:
			v.Request, err = _BarRequestRecur_Decode(sr)
			if err != nil {
				return err
			}
			requestIsSet = true
...
// Encode serializes a Bar_NormalRecur_Result struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Bar_NormalRecur_Result struct could not be encoded.
func (v *Bar_NormalRecur_Result) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
func _BarResponseRecur_Decode(sr stream.Reader) (*BarResponseRecur, error) {
	var v BarResponseRecur
	err := v.Decode(sr)
	return &v, err
}

// Decode deserializes a Bar_NormalRecur_Result struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Bar_NormalRecur_Result struct could not be generated from the wire
// representation.
func (v *Bar_NormalRecur_Result) Decode(sr stream.Reader) error {
	...
	for ok {
		switch {
		case fh.ID == 0 && fh.Type == wire.TStruct:
			v.Success, err = _BarResponseRecur_Decode(sr)
			if err != nil {
				return err
			}
...
// Encode serializes a Bar_TooManyArgs_Args struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Bar_TooManyArgs_Args struct could not be encoded.
func (v *Bar_TooManyArgs_Args) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
	...
	if v.Foo != nil {
		...
		if err := v.Foo.Encode(sw); err != nil {
			return err
		}
		if err := sw.WriteFieldEnd(); err != nil {
			return err
...
func _FooStruct_Decode(sr stream.Reader) (*foo.FooStruct, error) {
	var v foo.FooStruct
	err := v.Decode(sr)
	return &v, err
}

// Decode deserializes a Bar_TooManyArgs_Args struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Bar_TooManyArgs_Args struct could not be generated from the wire
// representation.
func (v *Bar_TooManyArgs_Args) Decode(sr stream.Reader) error {
	...
	for ok {
		...
		case fh.ID == 1 && fh.Type == wire.TStruct:
			...
			requestIsSet = true
		case fh.ID == 2 && fh.Type == wire.TStruct:
			v.Foo, err = _FooStruct_Decode(sr)
			if err != nil {
				return err
			}
...
// Encode serializes a Bar_TooManyArgs_Result struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Bar_TooManyArgs_Result struct could not be encoded.
func (v *Bar_TooManyArgs_Result) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
	...
	if v.FooException != nil {
		...
		if err := v.FooException.Encode(sw); err != nil {
			return err
		}
		if err := sw.WriteFieldEnd(); err != nil {
			return err
...
func _FooException_Decode(sr stream.Reader) (*foo.FooException, error) {
	var v foo.FooException
	err := v.Decode(sr)
	return &v, err
}

// Decode deserializes a Bar_TooManyArgs_Result struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Bar_TooManyArgs_Result struct could not be generated from the wire
// representation.
func (v *Bar_TooManyArgs_Result) Decode(sr stream.Reader) error {
	...
	for ok {
		...
		case fh.ID == 2 && fh.Type == wire.TStruct:
			v.FooException, err = _FooException_Decode(sr)
			if err != nil {
				return err
			}
...
// Encode serializes a Echo_EchoBinary_Args struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Echo_EchoBinary_Args struct could not be encoded.
func (v *Echo_EchoBinary_Args) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
	...
	if err := sw.WriteBinary(v.Arg); err != nil {
		return err
	}
	if err := sw.WriteFieldEnd(); err != nil {
		return err
...
// Decode deserializes a Echo_EchoBinary_Args struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Echo_EchoBinary_Args struct could not be generated from the wire
// representation.
func (v *Echo_EchoBinary_Args) Decode(sr stream.Reader) error {
...
// Encode serializes a Echo_EchoBinary_Result struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Echo_EchoBinary_Result struct could not be encoded.
func (v *Echo_EchoBinary_Result) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a Echo_EchoBinary_Result struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Echo_EchoBinary_Result struct could not be generated from the wire
// representation.
func (v *Echo_EchoBinary_Result) Decode(sr stream.Reader) error {
...
// Encode serializes a Echo_EchoBool_Args struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Echo_EchoBool_Args struct could not be encoded.
func (v *Echo_EchoBool_Args) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a Echo_EchoBool_Args struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Echo_EchoBool_Args struct could not be generated from the wire
// representation.
func (v *Echo_EchoBool_Args) Decode(sr stream.Reader) error {
...
// Encode serializes a Echo_EchoBool_Result struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Echo_EchoBool_Result struct could not be encoded.
func (v *Echo_EchoBool_Result) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a Echo_EchoBool_Result struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Echo_EchoBool_Result struct could not be generated from the wire
// representation.
func (v *Echo_EchoBool_Result) Decode(sr stream.Reader) error {
...
// Encode serializes a Echo_EchoDouble_Args struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Echo_EchoDouble_Args struct could not be encoded.
func (v *Echo_EchoDouble_Args) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
	...
	if err := sw.WriteDouble(v.Arg); err != nil {
		return err
	}
	if err := sw.WriteFieldEnd(); err != nil {
		return err
...
// Decode deserializes a Echo_EchoDouble_Args struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Echo_EchoDouble_Args struct could not be generated from the wire
// representation.
func (v *Echo_EchoDouble_Args) Decode(sr stream.Reader) error {
...
// Encode serializes a Echo_EchoDouble_Result struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Echo_EchoDouble_Result struct could not be encoded.
func (v *Echo_EchoDouble_Result) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a Echo_EchoDouble_Result struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Echo_EchoDouble_Result struct could not be generated from the wire
// representation.
func (v *Echo_EchoDouble_Result) Decode(sr stream.Reader) error {
...
// Default_Echo_EchoEnum_Args constructs a new Echo_EchoEnum_Args struct,
...
// Encode serializes a Echo_EchoEnum_Args struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Echo_EchoEnum_Args struct could not be encoded.
func (v *Echo_EchoEnum_Args) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a Echo_EchoEnum_Args struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Echo_EchoEnum_Args struct could not be generated from the wire
// representation.
func (v *Echo_EchoEnum_Args) Decode(sr stream.Reader) error {
...
// Encode serializes a Echo_EchoEnum_Result struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Echo_EchoEnum_Result struct could not be encoded.
func (v *Echo_EchoEnum_Result) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a Echo_EchoEnum_Result struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Echo_EchoEnum_Result struct could not be generated from the wire
// representation.
func (v *Echo_EchoEnum_Result) Decode(sr stream.Reader) error {
...
// Encode serializes a Echo_EchoI16_Args struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Echo_EchoI16_Args struct could not be encoded.
func (v *Echo_EchoI16_Args) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}

	if err := sw.WriteFieldBegin(stream.FieldHeader{ID: 1, Type: wire.TI16}); err != nil {
		return err
	}
	if err := sw.WriteInt16(v.Arg); err != nil {
		return err
	}
	if err := sw.WriteFieldEnd(); err != nil {
		return err
...
// Decode deserializes a Echo_EchoI16_Args struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Echo_EchoI16_Args struct could not be generated from the wire
// representation.
func (v *Echo_EchoI16_Args) Decode(sr stream.Reader) error {
	...
	for ok {
		switch {
		case fh.ID == 1 && fh.Type == wire.TI16:
			v.Arg, err = sr.ReadInt16()
			if err != nil {
				return err
			}
			argIsSet = true
...
// Encode serializes a Echo_EchoI16_Result struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Echo_EchoI16_Result struct could not be encoded.
func (v *Echo_EchoI16_Result) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}

	if v.Success != nil {
		if err := sw.WriteFieldBegin(stream.FieldHeader{ID: 0, Type: wire.TI16}); err != nil {
			return err
		}
		if err := sw.WriteInt16(*(v.Success)); err != nil {
			return err
		}
		if err := sw.WriteFieldEnd(); err != nil {
			return err
...
// Decode deserializes a Echo_EchoI16_Result struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Echo_EchoI16_Result struct could not be generated from the wire
// representation.
func (v *Echo_EchoI16_Result) Decode(sr stream.Reader) error {
	...
	for ok {
		switch {
		case fh.ID == 0 && fh.Type == wire.TI16:
			var x int16
			x, err = sr.ReadInt16()
			v.Success = &x
			if err != nil {
...
// Encode serializes a Echo_EchoI32_Args struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Echo_EchoI32_Args struct could not be encoded.
func (v *Echo_EchoI32_Args) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
	...
	if err := sw.WriteInt32(v.Arg); err != nil {
		return err
	}
	if err := sw.WriteFieldEnd(); err != nil {
		return err
...
// Decode deserializes a Echo_EchoI32_Args struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Echo_EchoI32_Args struct could not be generated from the wire
// representation.
func (v *Echo_EchoI32_Args) Decode(sr stream.Reader) error {
...
// Encode serializes a Echo_EchoI32_Result struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Echo_EchoI32_Result struct could not be encoded.
func (v *Echo_EchoI32_Result) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a Echo_EchoI32_Result struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Echo_EchoI32_Result struct could not be generated from the wire
// representation.
func (v *Echo_EchoI32_Result) Decode(sr stream.Reader) error {
...
func (m _Map_I32_BarResponse_MapItemList) ForEach(f func(wire.MapItem) error) error {
	for k, v := range m {
		if v == nil {
			return fmt.Errorf("invalid map 'map[int32]*BarResponse', key [%v]: value is nil", k)
		}
...
func _Map_I32_BarResponse_Encode(val map[int32]*BarResponse, sw stream.Writer) error {
...
// Encode serializes a Echo_EchoI32Map_Args struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Echo_EchoI32Map_Args struct could not be encoded.
func (v *Echo_EchoI32Map_Args) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
	...
	if err := _Map_I32_BarResponse_Encode(v.Arg, sw); err != nil {
		return err
	}
	if err := sw.WriteFieldEnd(); err != nil {
		return err
...
func _Map_I32_BarResponse_Decode(sr stream.Reader) (map[int32]*BarResponse, error) {
	mh, err := sr.ReadMapBegin()
	if err != nil {
		return nil, err
	}
	...
	o := make(map[int32]*BarResponse, mh.Length)
	for i := 0; i < mh.Length; i++ {
		k, err := sr.ReadInt32()
		if err != nil {
			return nil, err
...
// Decode deserializes a Echo_EchoI32Map_Args struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Echo_EchoI32Map_Args struct could not be generated from the wire
// representation.
func (v *Echo_EchoI32Map_Args) Decode(sr stream.Reader) error {
	...
	for ok {
		...
		case fh.ID == 1 && fh.Type == wire.TMap:
			v.Arg, err = _Map_I32_BarResponse_Decode(sr)
			if err != nil {
				return err
			}
			argIsSet = true
...
// Encode serializes a Echo_EchoI32Map_Result struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Echo_EchoI32Map_Result struct could not be encoded.
func (v *Echo_EchoI32Map_Result) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
	...
	if v.Success != nil {
		...
		if err := _Map_I32_BarResponse_Encode(v.Success, sw); err != nil {
			return err
		}
		if err := sw.WriteFieldEnd(); err != nil {
			return err
...
// Decode deserializes a Echo_EchoI32Map_Result struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Echo_EchoI32Map_Result struct could not be generated from the wire
// representation.
func (v *Echo_EchoI32Map_Result) Decode(sr stream.Reader) error {
	...
	for ok {
		...
		case fh.ID == 0 && fh.Type == wire.TMap:
			v.Success, err = _Map_I32_BarResponse_Decode(sr)
			if err != nil {
				return err
			}
...
// Encode serializes a Echo_EchoI64_Args struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Echo_EchoI64_Args struct could not be encoded.
func (v *Echo_EchoI64_Args) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a Echo_EchoI64_Args struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Echo_EchoI64_Args struct could not be generated from the wire
// representation.
func (v *Echo_EchoI64_Args) Decode(sr stream.Reader) error {
...
// Encode serializes a Echo_EchoI64_Result struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Echo_EchoI64_Result struct could not be encoded.
func (v *Echo_EchoI64_Result) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a Echo_EchoI64_Result struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Echo_EchoI64_Result struct could not be generated from the wire
// representation.
func (v *Echo_EchoI64_Result) Decode(sr stream.Reader) error {
...
// Encode serializes a Echo_EchoI8_Args struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Echo_EchoI8_Args struct could not be encoded.
func (v *Echo_EchoI8_Args) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
	...
	if err := sw.WriteInt8(v.Arg); err != nil {
		return err
	}
	if err := sw.WriteFieldEnd(); err != nil {
		return err
...
// Decode deserializes a Echo_EchoI8_Args struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Echo_EchoI8_Args struct could not be generated from the wire
// representation.
func (v *Echo_EchoI8_Args) Decode(sr stream.Reader) error {
...
// Encode serializes a Echo_EchoI8_Result struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Echo_EchoI8_Result struct could not be encoded.
func (v *Echo_EchoI8_Result) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a Echo_EchoI8_Result struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Echo_EchoI8_Result struct could not be generated from the wire
// representation.
func (v *Echo_EchoI8_Result) Decode(sr stream.Reader) error {
...
// Encode serializes a Echo_EchoString_Args struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Echo_EchoString_Args struct could not be encoded.
func (v *Echo_EchoString_Args) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a Echo_EchoString_Args struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Echo_EchoString_Args struct could not be generated from the wire
// representation.
func (v *Echo_EchoString_Args) Decode(sr stream.Reader) error {
...
// Encode serializes a Echo_EchoString_Result struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Echo_EchoString_Result struct could not be encoded.
func (v *Echo_EchoString_Result) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a Echo_EchoString_Result struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Echo_EchoString_Result struct could not be generated from the wire
// representation.
func (v *Echo_EchoString_Result) Decode(sr stream.Reader) error {
...
// Encode serializes a Echo_EchoStringList_Args struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Echo_EchoStringList_Args struct could not be encoded.
func (v *Echo_EchoStringList_Args) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
	...
	if err := _List_String_Encode(v.Arg, sw); err != nil {
		return err
	}
	if err := sw.WriteFieldEnd(); err != nil {
		return err
...
// Decode deserializes a Echo_EchoStringList_Args struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Echo_EchoStringList_Args struct could not be generated from the wire
// representation.
func (v *Echo_EchoStringList_Args) Decode(sr stream.Reader) error {
	...
	for ok {
		switch {
		case fh.ID == 1 && fh.Type == wire.TList:
			v.Arg, err = _List_String_Decode(sr)
			if err != nil {
				return err
			}
			argIsSet = true
...
// Encode serializes a Echo_EchoStringList_Result struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Echo_EchoStringList_Result struct could not be encoded.
func (v *Echo_EchoStringList_Result) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
	...
	if v.Success != nil {
		...
		if err := _List_String_Encode(v.Success, sw); err != nil {
			return err
		}
		if err := sw.WriteFieldEnd(); err != nil {
			return err
...
// Decode deserializes a Echo_EchoStringList_Result struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Echo_EchoStringList_Result struct could not be generated from the wire
// representation.
func (v *Echo_EchoStringList_Result) Decode(sr stream.Reader) error {
	...
	for ok {
		...
		case fh.ID == 0 && fh.Type == wire.TList:
			v.Success, err = _List_String_Decode(sr)
			if err != nil {
				return err
			}
...
func (m _Map_String_BarResponse_MapItemList) ForEach(f func(wire.MapItem) error) error {
	for k, v := range m {
		if v == nil {
			return fmt.Errorf("invalid map 'map[string]*BarResponse', key [%v]: value is nil", k)
		}
		kw, err := wire.NewValueString(k), error(nil)
		if err != nil {
			return err
...
func _Map_String_BarResponse_Encode(val map[string]*BarResponse, sw stream.Writer) error {
...
// Encode serializes a Echo_EchoStringMap_Args struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Echo_EchoStringMap_Args struct could not be encoded.
func (v *Echo_EchoStringMap_Args) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
	...
	if err := _Map_String_BarResponse_Encode(v.Arg, sw); err != nil {
		return err
	}
	if err := sw.WriteFieldEnd(); err != nil {
		return err
...
func _Map_String_BarResponse_Decode(sr stream.Reader) (map[string]*BarResponse, error) {
	mh, err := sr.ReadMapBegin()
	if err != nil {
		return nil, err
	}
	...
	o := make(map[string]*BarResponse, mh.Length)
	for i := 0; i < mh.Length; i++ {
		k, err := sr.ReadString()
		if err != nil {
			return nil, err
...
// Decode deserializes a Echo_EchoStringMap_Args struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Echo_EchoStringMap_Args struct could not be generated from the wire
// representation.
func (v *Echo_EchoStringMap_Args) Decode(sr stream.Reader) error {
	...
	for ok {
		switch {
		case fh.ID == 1 && fh.Type == wire.TMap:
			v.Arg, err = _Map_String_BarResponse_Decode(sr)
			if err != nil {
				return err
			}
			argIsSet = true
...
// Encode serializes a Echo_EchoStringMap_Result struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Echo_EchoStringMap_Result struct could not be encoded.
func (v *Echo_EchoStringMap_Result) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
	...
	if v.Success != nil {
		...
		if err := _Map_String_BarResponse_Encode(v.Success, sw); err != nil {
			return err
		}
		if err := sw.WriteFieldEnd(); err != nil {
			return err
...
// Decode deserializes a Echo_EchoStringMap_Result struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Echo_EchoStringMap_Result struct could not be generated from the wire
// representation.
func (v *Echo_EchoStringMap_Result) Decode(sr stream.Reader) error {
	...
	for ok {
		switch {
		case fh.ID == 0 && fh.Type == wire.TMap:
			v.Success, err = _Map_String_BarResponse_Decode(sr)
			if err != nil {
				return err
			}
...
// Encode serializes a Echo_EchoStringSet_Args struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Echo_EchoStringSet_Args struct could not be encoded.
func (v *Echo_EchoStringSet_Args) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
	...
	if err := _Set_String_mapType_Encode(v.Arg, sw); err != nil {
		return err
	}
	if err := sw.WriteFieldEnd(); err != nil {
		return err
...
// Decode deserializes a Echo_EchoStringSet_Args struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Echo_EchoStringSet_Args struct could not be generated from the wire
// representation.
func (v *Echo_EchoStringSet_Args) Decode(sr stream.Reader) error {
	...
	for ok {
		...
		case fh.ID == 1 && fh.Type == wire.TSet:
			v.Arg, err = _Set_String_mapType_Decode(sr)
			if err != nil {
				return err
			}
			argIsSet = true
...
// Encode serializes a Echo_EchoStringSet_Result struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Echo_EchoStringSet_Result struct could not be encoded.
func (v *Echo_EchoStringSet_Result) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
	...
	if v.Success != nil {
		...
		if err := _Set_String_mapType_Encode(v.Success, sw); err != nil {
			return err
		}
		if err := sw.WriteFieldEnd(); err != nil {
			return err
...
// Decode deserializes a Echo_EchoStringSet_Result struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Echo_EchoStringSet_Result struct could not be generated from the wire
// representation.
func (v *Echo_EchoStringSet_Result) Decode(sr stream.Reader) error {
	...
	for ok {
		...
		case fh.ID == 0 && fh.Type == wire.TSet:
			v.Success, err = _Set_String_mapType_Decode(sr)
			if err != nil {
				return err
			}
...
func (v _List_BarResponse_ValueList) ForEach(f func(wire.Value) error) error {
	for i, x := range v {
		if x == nil {
			return fmt.Errorf("invalid list '[]*BarResponse', index [%v]: value is nil", i)
		}
		w, err := x.ToWire()
		if err != nil {
			return err
...
func _List_BarResponse_Encode(val []*BarResponse, sw stream.Writer) error {
...
// Encode serializes a Echo_EchoStructList_Args struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Echo_EchoStructList_Args struct could not be encoded.
func (v *Echo_EchoStructList_Args) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
	...
	if err := _List_BarResponse_Encode(v.Arg, sw); err != nil {
		return err
	}
	if err := sw.WriteFieldEnd(); err != nil {
		return err
...
func _List_BarResponse_Decode(sr stream.Reader) ([]*BarResponse, error) {
	lh, err := sr.ReadListBegin()
	if err != nil {
		return nil, err
	}
	...
	o := make([]*BarResponse, 0, lh.Length)
	for i := 0; i < lh.Length; i++ {
		v, err := _BarResponse_Decode(sr)
		if err != nil {
			return nil, err
...
// Decode deserializes a Echo_EchoStructList_Args struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Echo_EchoStructList_Args struct could not be generated from the wire
// representation.
func (v *Echo_EchoStructList_Args) Decode(sr stream.Reader) error {
	...
	for ok {
		switch {
		case fh.ID == 1 && fh.Type == wire.TList:
			v.Arg, err = _List_BarResponse_Decode(sr)
			if err != nil {
				return err
			}
			argIsSet = true
...
// Encode serializes a Echo_EchoStructList_Result struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Echo_EchoStructList_Result struct could not be encoded.
func (v *Echo_EchoStructList_Result) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
	...
	if v.Success != nil {
		...
		if err := _List_BarResponse_Encode(v.Success, sw); err != nil {
			return err
		}
		if err := sw.WriteFieldEnd(); err != nil {
			return err
...
// Decode deserializes a Echo_EchoStructList_Result struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Echo_EchoStructList_Result struct could not be generated from the wire
// representation.
func (v *Echo_EchoStructList_Result) Decode(sr stream.Reader) error {
	...
	for ok {
		switch {
		case fh.ID == 0 && fh.Type == wire.TList:
			v.Success, err = _List_BarResponse_Decode(sr)
			if err != nil {
				return err
			}
...
func (m _Map_BarResponse_String_MapItemList) ForEach(f func(wire.MapItem) error) error {
	for _, i := range m {
		...
		v := i.Value
		if k == nil {
			return fmt.Errorf("invalid map '[]struct{Key *BarResponse; Value string}': key is nil")
		}
		kw, err := k.ToWire()
		if err != nil {
			return err
...
func _Map_BarResponse_String_Encode(val []struct {
	Key   *BarResponse
	Value string
...
// Encode serializes a Echo_EchoStructMap_Args struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Echo_EchoStructMap_Args struct could not be encoded.
func (v *Echo_EchoStructMap_Args) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
	...
	if err := _Map_BarResponse_String_Encode(v.Arg, sw); err != nil {
		return err
	}
	if err := sw.WriteFieldEnd(); err != nil {
		return err
...
func _Map_BarResponse_String_Decode(sr stream.Reader) ([]struct {
	Key   *BarResponse
	Value string
}, error) {
	mh, err := sr.ReadMapBegin()
...
// Decode deserializes a Echo_EchoStructMap_Args struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Echo_EchoStructMap_Args struct could not be generated from the wire
// representation.
func (v *Echo_EchoStructMap_Args) Decode(sr stream.Reader) error {
	...
	for ok {
		switch {
		case fh.ID == 1 && fh.Type == wire.TMap:
			v.Arg, err = _Map_BarResponse_String_Decode(sr)
			if err != nil {
				return err
			}
			argIsSet = true
...
// Encode serializes a Echo_EchoStructMap_Result struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Echo_EchoStructMap_Result struct could not be encoded.
func (v *Echo_EchoStructMap_Result) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
	...
	if v.Success != nil {
		...
		if err := _Map_BarResponse_String_Encode(v.Success, sw); err != nil {
			return err
		}
		if err := sw.WriteFieldEnd(); err != nil {
			return err
...
// Decode deserializes a Echo_EchoStructMap_Result struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Echo_EchoStructMap_Result struct could not be generated from the wire
// representation.
func (v *Echo_EchoStructMap_Result) Decode(sr stream.Reader) error {
	...
	for ok {
		switch {
		case fh.ID == 0 && fh.Type == wire.TMap:
			v.Success, err = _Map_BarResponse_String_Decode(sr)
			if err != nil {
				return err
			}
...
func (v _Set_BarResponse_sliceType_ValueList) ForEach(f func(wire.Value) error) error {
	for _, x := range v {
		if x == nil {
			return fmt.Errorf("invalid set '*BarResponse': contains nil value")
		}
		w, err := x.ToWire()
		if err != nil {
			return err
...
func _Set_BarResponse_sliceType_Encode(val []*BarResponse, sw stream.Writer) error {
...
// Encode serializes a Echo_EchoStructSet_Args struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Echo_EchoStructSet_Args struct could not be encoded.
func (v *Echo_EchoStructSet_Args) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
	...
	if err := _Set_BarResponse_sliceType_Encode(v.Arg, sw); err != nil {
		return err
	}
	if err := sw.WriteFieldEnd(); err != nil {
		return err
...
func _Set_BarResponse_sliceType_Decode(sr stream.Reader) ([]*BarResponse, error) {
	sh, err := sr.ReadSetBegin()
	if err != nil {
		return nil, err
	}
	...
	o := make([]*BarResponse, 0, sh.Length)
	for i := 0; i < sh.Length; i++ {
		v, err := _BarResponse_Decode(sr)
		if err != nil {
			return nil, err
...
// Decode deserializes a Echo_EchoStructSet_Args struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Echo_EchoStructSet_Args struct could not be generated from the wire
// representation.
func (v *Echo_EchoStructSet_Args) Decode(sr stream.Reader) error {
	...
	for ok {
		switch {
		case fh.ID == 1 && fh.Type == wire.TSet:
			v.Arg, err = _Set_BarResponse_sliceType_Decode(sr)
			if err != nil {
				return err
			}
			argIsSet = true
...
// Encode serializes a Echo_EchoStructSet_Result struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Echo_EchoStructSet_Result struct could not be encoded.
func (v *Echo_EchoStructSet_Result) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
	...
	if v.Success != nil {
		...
		if err := _Set_BarResponse_sliceType_Encode(v.Success, sw); err != nil {
			return err
		}
		if err := sw.WriteFieldEnd(); err != nil {
			return err
...
// Decode deserializes a Echo_EchoStructSet_Result struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Echo_EchoStructSet_Result struct could not be generated from the wire
// representation.
func (v *Echo_EchoStructSet_Result) Decode(sr stream.Reader) error {
	...
	for ok {
		switch {
		case fh.ID == 0 && fh.Type == wire.TSet:
			v.Success, err = _Set_BarResponse_sliceType_Decode(sr)
			if err != nil {
				return err
			}
...
// Encode serializes a Echo_EchoTypedef_Args struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Echo_EchoTypedef_Args struct could not be encoded.
func (v *Echo_EchoTypedef_Args) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a Echo_EchoTypedef_Args struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Echo_EchoTypedef_Args struct could not be generated from the wire
// representation.
func (v *Echo_EchoTypedef_Args) Decode(sr stream.Reader) error {
...
// Encode serializes a Echo_EchoTypedef_Result struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a Echo_EchoTypedef_Result struct could not be encoded.
func (v *Echo_EchoTypedef_Result) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a Echo_EchoTypedef_Result struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a Echo_EchoTypedef_Result struct could not be generated from the wire
// representation.
func (v *Echo_EchoTypedef_Result) Decode(sr stream.Reader) error {
