...
// @generated
// Checksum : eeB0k3hZbE+UFe+1c6cpDw==
...
func easyjson6601e8cdDecodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeEndpointsWithexceptionsWithexceptions(in *jlexer.Lexer, out *EndpointExceptionType2) {
...
func easyjson6601e8cdEncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeEndpointsWithexceptionsWithexceptions(out *jwriter.Writer, in EndpointExceptionType2) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson6601e8cdDecodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeEndpointsWithexceptionsWithexceptions1(in *jlexer.Lexer, out *EndpointExceptionType1) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson6601e8cdEncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeEndpointsWithexceptionsWithexceptions1(out *jwriter.Writer, in EndpointExceptionType1) {
	out.RawByte('{')
	first := true
	_ = first
	{
