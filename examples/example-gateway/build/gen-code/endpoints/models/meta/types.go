...
func (v *Dgx) GetS1() (o string) { return v.S1 }

// GetI2 returns the value of I2 if it is set or its
// zero value if it is unset.
func (v *Dgx) GetI2() (o int32) { return v.I2 }
...
// zero value if it is unset.
func (v *Fred) GetContentType() (o string) { return v.ContentType }

// GetAuth returns the value of Auth if it is set or its
// zero value if it is unset.
func (v *Fred) GetAuth() (o string) { return v.Auth }
...
// GetToken returns the value of Token if it is set or its
// zero value if it is unset.
func (v *TokenOnly) GetToken() (o string) { return v.Token }
...
// GetUUID returns the value of UUID if it is set or its
// zero value if it is unset.
func (v *UUIDOnly) GetUUID() (o string) { return v.UUID }
