	...
	for !in.IsDelim('}') {
		...
		case "authErr":
			if in.IsNull() {
				...
				easyjson29c9c5f5DecodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeEndpointsTchannelBazBaz(in, &*out.AuthErr)
			}
		case "serverErr":
			if in.IsNull() {
				in.Skip()
				...
				easyjson29c9c5f5DecodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeEndpointsTchannelBazBaz1(in, &*out.ServerErr)
			}
		default:
			in.SkipRecursive()
		}
...
func easyjson29c9c5f5EncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeEndpointsTchannelBazBazSimpleServiceSillyNoop(out *jwriter.Writer, in SimpleService_SillyNoop_Result) {
	...
	if in.AuthErr != nil {
		...
		if in.AuthErr == nil {
			...
			easyjson29c9c5f5EncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeEndpointsTchannelBazBaz(out, *in.AuthErr)
		}
	}
	if in.ServerErr != nil {
		if !first {
		...
		if in.ServerErr == nil {
			...
			easyjson29c9c5f5EncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeEndpointsTchannelBazBaz1(out, *in.ServerErr)
		}
	}
	out.RawByte('}')
}
...
func easyjson29c9c5f5DecodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeEndpointsTchannelBazBaz1(in *jlexer.Lexer, out *ServerErr) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson29c9c5f5EncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeEndpointsTchannelBazBaz1(out *jwriter.Writer, in ServerErr) {
	out.RawByte('{')
	first := true
	_ = first
	if !first {
...
func easyjson29c9c5f5DecodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeEndpointsTchannelBazBaz(in *jlexer.Lexer, out *AuthErr) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson29c9c5f5EncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeEndpointsTchannelBazBaz(out *jwriter.Writer, in AuthErr) {
	out.RawByte('{')
	first := true
	_ = first
	if !first {
