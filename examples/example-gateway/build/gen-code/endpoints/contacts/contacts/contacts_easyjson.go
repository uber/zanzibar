...
// @generated
// Checksum : 5B3Pt2UTYZL+5sNN7af0Nw==
...
func easyjson4ee781cfDecodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeEndpointsContactsContacts2(in *jlexer.Lexer, out *ContactFragment) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson4ee781cfEncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeEndpointsContactsContacts2(out *jwriter.Writer, in ContactFragment) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Type != nil {
...
func easyjson4ee781cfDecodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeEndpointsContactsContacts3(in *jlexer.Lexer, out *ContactAttributes) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson4ee781cfEncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeEndpointsContactsContacts3(out *jwriter.Writer, in ContactAttributes) {
	out.RawByte('{')
	first := true
	_ = first
	if in.FirstName != nil {
...
func easyjson4ee781cfDecodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeEndpointsContactsContacts4(in *jlexer.Lexer, out *Contact) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson4ee781cfEncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeEndpointsContactsContacts4(out *jwriter.Writer, in Contact) {
	out.RawByte('{')
	first := true
	_ = first
