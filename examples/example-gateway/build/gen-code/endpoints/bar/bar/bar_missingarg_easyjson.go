	...
	for !in.IsDelim('}') {
		...
		case "resp":
			if in.IsNull() {
				...
				easyjsonCc65dbaeDecodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeEndpointsBarBar2(in, &*out.Resp)
			}
		default:
			in.SkipRecursive()
		}
...
func easyjsonCc65dbaeEncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeEndpointsBarBar(out *jwriter.Writer, in BarResponse) {
	...
	if in.Resp != nil {
		...
		if in.Resp == nil {
			...
			easyjsonCc65dbaeEncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeEndpointsBarBar2(out, *in.Resp)
		}
	}
	out.RawByte('}')
}
func easyjsonCc65dbaeDecodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeEndpointsBarBar2(in *jlexer.Lexer, out *BarRequestRecur) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "recur":
			if in.IsNull() {
				...
				easyjsonCc65dbaeDecodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeEndpointsBarBar2(in, &*out.Recur)
			}
		default:
			in.SkipRecursive()
		}
...
func easyjsonCc65dbaeEncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeEndpointsBarBar2(out *jwriter.Writer, in BarRequestRecur) {
	out.RawByte('{')
	first := true
	_ = first
	if !first {
	...
	if in.Recur != nil {
		...
		if in.Recur == nil {
			...
			easyjsonCc65dbaeEncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeEndpointsBarBar2(out, *in.Recur)
		}
	}
	out.RawByte('}')
}
