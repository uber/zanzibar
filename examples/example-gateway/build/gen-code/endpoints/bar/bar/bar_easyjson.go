		...
		case "demoIds":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.DemoIds = append(out.DemoIds, v10)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "aListUUID":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v19 UUID
					v19 = UUID(in.String())
					out.AListUUID = append(out.AListUUID, v19)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "anOptListUUID":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v20 UUID
					v20 = UUID(in.String())
					out.AnOptListUUID = append(out.AnOptListUUID, v20)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "aStringList":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.AStringList = append(out.AStringList, v21)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "anOptStringList":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.AnOptStringList = append(out.AnOptStringList, v22)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "aUUIDList":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v23 UUID
					v23 = UUID(in.String())
					out.AUUIDList = append(out.AUUIDList, v23)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "anOptUUIDList":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v24 UUID
					v24 = UUID(in.String())
					out.AnOptUUIDList = append(out.AnOptUUIDList, v24)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson4347b5c1EncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeEndpointsBarBarBarArgWithManyQueryParams1(out *jwriter.Writer, in Bar_ArgWithManyQueryParams_Args) {
	...
	}
	{
		...
		if in.AListUUID == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v25, v26 := range in.AListUUID {
				if v25 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.AnOptListUUID) != 0 {
		...
		{
			out.RawByte('[')
			for v27, v28 := range in.AnOptListUUID {
				if v27 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.AStringList == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v29, v30 := range in.AStringList {
				if v29 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.AnOptStringList) != 0 {
		...
		{
			out.RawByte('[')
			for v31, v32 := range in.AnOptStringList {
				if v31 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.AUUIDList == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v33, v34 := range in.AUUIDList {
				if v33 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.AnOptUUIDList) != 0 {
		...
		{
			out.RawByte('[')
			for v35, v36 := range in.AnOptUUIDList {
				if v35 > 0 {
					out.RawByte(',')
				}
		...
		case "mapIntWithoutRange":
			if in.IsNull() {
				...
				for !in.IsDelim('}') {
					...
					var v38 int32
					v38 = int32(in.Int32())
					(out.MapIntWithoutRange)[key] = v38
					in.WantComma()
				}
				in.Delim('}')
			}
...
func easyjson4347b5c1EncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeEndpointsBarBar6(out *jwriter.Writer, in BarResponse) {
	...
	}
	{
		...
		if in.MapIntWithRange == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v40First := true
			for v40Name, v40Value := range in.MapIntWithRange {
				if v40First {
					v40First = false
				} else {
					out.RawByte(',')
	...
	}
	{
		...
		if in.MapIntWithoutRange == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v41First := true
			for v41Name, v41Value := range in.MapIntWithoutRange {
				if v41First {
					v41First = false
				} else {
					out.RawByte(',')
