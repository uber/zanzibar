...
// @generated
// Checksum : 3/Fiw1ku1eV+qvOh6TLBEw==
		...
		case "aListUUID":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v15 UUID
					v15 = UUID(in.String())
					out.AListUUID = append(out.AListUUID, v15)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "anOptListUUID":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v16 UUID
					v16 = UUID(in.String())
					out.AnOptListUUID = append(out.AnOptListUUID, v16)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "aStringList":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.AStringList = append(out.AStringList, v17)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "anOptStringList":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.AnOptStringList = append(out.AnOptStringList, v18)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "aUUIDList":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v19 UUID
					v19 = UUID(in.String())
					out.AUUIDList = append(out.AUUIDList, v19)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "anOptUUIDList":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v20 UUID
					v20 = UUID(in.String())
					out.AnOptUUIDList = append(out.AnOptUUIDList, v20)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson4347b5c1EncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeEndpointsBarBarBarArgWithManyQueryParams1(out *jwriter.Writer, in Bar_ArgWithManyQueryParams_Args) {
	...
	}
	{
		...
		if in.AListUUID == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v21, v22 := range in.AListUUID {
				if v21 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.AnOptListUUID) != 0 {
		...
		{
			out.RawByte('[')
			for v23, v24 := range in.AnOptListUUID {
				if v23 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.AStringList == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v25, v26 := range in.AStringList {
				if v25 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.AnOptStringList) != 0 {
		...
		{
			out.RawByte('[')
			for v27, v28 := range in.AnOptStringList {
				if v27 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.AUUIDList == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v29, v30 := range in.AUUIDList {
				if v29 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.AnOptUUIDList) != 0 {
		...
		{
			out.RawByte('[')
			for v31, v32 := range in.AnOptUUIDList {
				if v31 > 0 {
					out.RawByte(',')
				}
		...
		case "mapIntWithoutRange":
			if in.IsNull() {
				...
				for !in.IsDelim('}') {
					...
					var v34 int32
					v34 = int32(in.Int32())
					(out.MapIntWithoutRange)[key] = v34
					in.WantComma()
				}
				in.Delim('}')
			}
...
func easyjson4347b5c1EncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeEndpointsBarBar4(out *jwriter.Writer, in BarResponse) {
	...
	}
	{
		...
		if in.MapIntWithRange == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v36First := true
			for v36Name, v36Value := range in.MapIntWithRange {
				if v36First {
					v36First = false
				} else {
					out.RawByte(',')
	...
	}
	{
		...
		if in.MapIntWithoutRange == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v37First := true
			for v37Name, v37Value := range in.MapIntWithoutRange {
				if v37First {
					v37First = false
				} else {
					out.RawByte(',')
