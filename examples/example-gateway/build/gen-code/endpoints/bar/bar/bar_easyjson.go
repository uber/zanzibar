...
// @generated
// Checksum : pSXULWXG4n0fUmKNYqH0LQ==
...
func easyjson4347b5c1EncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeEndpointsBarBarBarArgWithQueryParams1(out *jwriter.Writer, in Bar_ArgWithQueryParams_Args) {
	...
	if len(in.Baz) != 0 {
		...
		out.RawString(prefix)
		{
			out.RawByte('{')
			v17First := true
			for v17Name, v17Value := range in.Baz {
				if v17First {
					v17First = false
				} else {
					out.RawByte(',')
				...
				out.RawByte(':')
				easyjson4347b5c1Encode(out, v17Value)
			}
			out.RawByte('}')
		}
	}
	if len(in.Bazbaz) != 0 {
		...
		out.RawString(prefix)
		{
			out.RawByte('{')
			v18First := true
			for v18Name, v18Value := range in.Bazbaz {
				if v18First {
					v18First = false
				} else {
					out.RawByte(',')
				...
				out.RawByte(':')
				easyjson4347b5c1Encode(out, v18Value)
			}
			out.RawByte('}')
		}
	}
