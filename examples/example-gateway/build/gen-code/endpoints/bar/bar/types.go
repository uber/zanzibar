...
type I64TestField struct {
	I64Field  int64     `json:"i64Field,required"`
	Timestamp Timestamp `json:"timestamp,required"`
	LongField Long      `json:"longField,required"`
}

// ToWire translates a I64TestField struct into a Thrift-level intermediate
// representation. This intermediate representation may be serialized
// into bytes using a ThriftRW protocol implementation.
//
// An error is returned if the struct or any of its fields failed to
...
//     return err
//   }
func (v *I64TestField) ToWire() (wire.Value, error) {
	var (
		fields [3]wire.Field
		i      int = 0
		w      wire.Value
...
// FromWire deserializes a I64TestField struct from its Thrift-level
// representation. The Thrift-level representation may be obtained
// from a ThriftRW protocol implementation.
//
// An error is returned if we were unable to build a I64TestField struct
// from the provided intermediate representation.
//
//   x, err := binaryProtocol.Decode(reader, wire.TStruct)
//   if err != nil {
...
//   }
//   return &v, nil
func (v *I64TestField) FromWire(w wire.Value) error {
	var err error
	...
	if !i64FieldIsSet {
		return errors.New("field I64Field of I64TestField is required")
	}

	if !timestampIsSet {
		return errors.New("field Timestamp of I64TestField is required")
	}

	if !longFieldIsSet {
		return errors.New("field LongField of I64TestField is required")
	}

	return nil
}

// String returns a readable string representation of a I64TestField
// struct.
func (v *I64TestField) String() string {
	if v == nil {
		return "<nil>"
	}
	...
	return fmt.Sprintf("I64TestField{%v}", strings.Join(fields[:i], ", "))
}

// Equals returns true if all the fields of this I64TestField match the
// provided I64TestField.
//
// This function performs a deep comparison.
func (v *I64TestField) Equals(rhs *I64TestField) bool {
