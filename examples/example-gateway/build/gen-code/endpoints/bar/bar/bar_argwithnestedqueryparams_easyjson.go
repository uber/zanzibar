	...
	for !in.IsDelim('}') {
		...
		case "opt":
			if in.IsNull() {
				...
				easyjson883a4a87DecodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeEndpointsBarBar1(in, &*out.Opt)
			}
		default:
			in.SkipRecursive()
		}
...
func easyjson883a4a87EncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeEndpointsBarBarBarArgWithNestedQueryParams1(out *jwriter.Writer, in Bar_ArgWithNestedQueryParams_Args) {
	...
	if in.Opt != nil {
		...
		if in.Opt == nil {
			...
			easyjson883a4a87EncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeEndpointsBarBar1(out, *in.Opt)
		}
	}
	out.RawByte('}')
}
