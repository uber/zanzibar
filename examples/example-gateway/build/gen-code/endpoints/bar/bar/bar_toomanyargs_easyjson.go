...
// @generated
// Checksum : TitFxOytJJdxgwgtcYzY2g==
	...
	for !in.IsDelim('}') {
		...
		case "i64TestField":
			if in.IsNull() {
				...
				easyjson87e68f88DecodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeEndpointsBarBar3(in, &*out.I64TestField)
			}
...
func easyjson87e68f88EncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeEndpointsBarBar2(out *jwriter.Writer, in BarRequest) {
	...
	if in.I64TestField == nil {
		...
		easyjson87e68f88EncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeEndpointsBarBar3(out, *in.I64TestField)
	}
	out.RawByte('}')
}
func easyjson87e68f88DecodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeEndpointsBarBar3(in *jlexer.Lexer, out *I64TestField) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson87e68f88EncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeEndpointsBarBar3(out *jwriter.Writer, in I64TestField) {
	out.RawByte('{')
	first := true
	_ = first
	if !first {
