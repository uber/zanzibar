...
import (
	"errors"
	"fmt"
	"github.com/uber/zanzibar/examples/example-gateway/build/gen-code/endpoints/foo/base/base"
...
func (v *FooException) GetTeapot() (o string) { return v.Teapot }
...
// zero value if it is unset.
func (v *FooStruct) GetFooString() (o string) { return v.FooString }
