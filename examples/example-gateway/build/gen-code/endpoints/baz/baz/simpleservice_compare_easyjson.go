	...
	for !in.IsDelim('}') {
		...
		case "arg1":
			if in.IsNull() {
				...
				easyjson4d8a931DecodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeEndpointsBazBaz2(in, &*out.Arg1)
			}
			Arg1Set = true
		case "arg2":
			if in.IsNull() {
				...
				easyjson4d8a931DecodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeEndpointsBazBaz2(in, &*out.Arg2)
			}
			Arg2Set = true
		default:
			in.SkipRecursive()
...
func easyjson4d8a931EncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeEndpointsBazBazSimpleServiceCompare1(out *jwriter.Writer, in SimpleService_Compare_Args) {
	...
	if in.Arg1 == nil {
		...
		easyjson4d8a931EncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeEndpointsBazBaz2(out, *in.Arg1)
	}
	if !first {
		out.RawByte(',')
	}
	...
	if in.Arg2 == nil {
		...
		easyjson4d8a931EncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeEndpointsBazBaz2(out, *in.Arg2)
	}
	out.RawByte('}')
}
...
func easyjson4d8a931DecodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeEndpointsBazBaz2(in *jlexer.Lexer, out *BazRequest) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson4d8a931EncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeEndpointsBazBaz2(out *jwriter.Writer, in BazRequest) {
	out.RawByte('{')
	first := true
	_ = first
	if !first {
