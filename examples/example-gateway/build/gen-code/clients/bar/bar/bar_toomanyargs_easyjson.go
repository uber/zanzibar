...
// @generated
// Checksum : tYZu5kB4q3vw7hI9K3g20g==
	...
	for !in.IsDelim('}') {
		...
		case "nextResponse":
			if in.IsNull() {
				...
				easyjson87e68f88DecodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBar(in, out.NextResponse)
			}
		default:
			in.SkipRecursive()
		}
...
func easyjson87e68f88EncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBar(out *jwriter.Writer, in BarResponse) {
	...
	if in.NextResponse != nil {
		...
		easyjson87e68f88EncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBar(out, *in.NextResponse)
	}
	out.RawByte('}')
}
