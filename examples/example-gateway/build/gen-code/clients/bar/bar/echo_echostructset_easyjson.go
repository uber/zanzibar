...
// @generated
// Checksum : 7+CWj4VXwRi9h76tPaEjdA==
			...
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					if in.IsNull() {
						...
						easyjsonF2b6890eDecodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBar(in, &*v8)
					}
	...
	if in.Arg == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
		...
		for v9, v10 := range in.Arg {
			...
			if v10 == nil {
				...
				easyjsonF2b6890eEncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBar(out, *v10)
			}
		}
		out.RawByte(']')
	}
