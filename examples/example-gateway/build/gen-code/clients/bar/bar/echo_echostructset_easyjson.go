...
// @generated
// Checksum : 4xpXibDH84ot5wtPGKVRJg==
	...
	for !in.IsDelim('}') {
		...
		case "nextResponse":
			if in.IsNull() {
				...
				easyjsonF2b6890eDecodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBar(in, &*out.NextResponse)
			}
		default:
			in.SkipRecursive()
		}
...
func easyjsonF2b6890eEncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBar(out *jwriter.Writer, in BarResponse) {
	...
	if in.NextResponse != nil {
		...
		easyjsonF2b6890eEncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBar(out, *in.NextResponse)
	}
	out.RawByte('}')
}
