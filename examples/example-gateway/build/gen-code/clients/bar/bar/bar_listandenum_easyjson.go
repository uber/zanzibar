	...
	for !in.IsDelim('}') {
		...
		case "barException":
			if in.IsNull() {
				...
				easyjson5553a28cDecodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBar(in, &*out.BarException)
			}
		default:
			in.SkipRecursive()
		}
...
func easyjson5553a28cEncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBarBarListAndEnum(out *jwriter.Writer, in Bar_ListAndEnum_Result) {
	...
	if in.BarException != nil {
		...
		easyjson5553a28cEncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBar(out, *in.BarException)
	}
	out.RawByte('}')
}
...
func easyjson5553a28cDecodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBar(in *jlexer.Lexer, out *BarException) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson5553a28cEncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBar(out *jwriter.Writer, in BarException) {
	out.RawByte('{')
	first := true
	_ = first
	{
