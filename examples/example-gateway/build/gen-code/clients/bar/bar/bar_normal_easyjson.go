	...
	for !in.IsDelim('}') {
		...
		case "requestRecur":
			if in.IsNull() {
				...
				easyjsonBea79dfbDecodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBar3(in, &*out.RequestRecur)
			}
		default:
			in.SkipRecursive()
		}
...
func easyjsonBea79dfbEncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBarBarNormal1(out *jwriter.Writer, in Bar_Normal_Args) {
	...
	if in.RequestRecur != nil {
		...
		if in.RequestRecur == nil {
			...
			easyjsonBea79dfbEncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBar3(out, *in.RequestRecur)
		}
	}
	out.RawByte('}')
}
...
func easyjsonBea79dfbDecodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBar3(in *jlexer.Lexer, out *BarRequestRecur) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "recur":
			if in.IsNull() {
				...
				easyjsonBea79dfbDecodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBar3(in, &*out.Recur)
			}
		default:
			in.SkipRecursive()
		}
...
func easyjsonBea79dfbEncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBar3(out *jwriter.Writer, in BarRequestRecur) {
	out.RawByte('{')
	first := true
	_ = first
	if !first {
	...
	if in.Recur != nil {
		...
		if in.Recur == nil {
			...
			easyjsonBea79dfbEncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBar3(out, *in.Recur)
		}
	}
	out.RawByte('}')
}
