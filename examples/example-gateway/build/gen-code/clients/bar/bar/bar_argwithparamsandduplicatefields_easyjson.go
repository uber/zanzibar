	...
	for !in.IsDelim('}') {
		...
		case "success":
			if in.IsNull() {
				...
				easyjsonAc132a5fDecodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBar(in, &*out.Success)
			}
		default:
			in.SkipRecursive()
		}
...
func easyjsonAc132a5fEncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBarBarArgWithParamsAndDuplicateFields(out *jwriter.Writer, in Bar_ArgWithParamsAndDuplicateFields_Result) {
	...
	if in.Success != nil {
		...
		easyjsonAc132a5fEncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBar(out, *in.Success)
	}
	out.RawByte('}')
}
...
func easyjsonAc132a5fDecodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBar(in *jlexer.Lexer, out *BarResponse) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "nextResponse":
			if in.IsNull() {
				...
				easyjsonAc132a5fDecodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBar(in, &*out.NextResponse)
			}
		default:
			in.SkipRecursive()
		}
...
func easyjsonAc132a5fEncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBar(out *jwriter.Writer, in BarResponse) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	if in.NextResponse != nil {
		...
		easyjsonAc132a5fEncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBar(out, *in.NextResponse)
	}
	out.RawByte('}')
}
	...
	for !in.IsDelim('}') {
		...
		case "request":
			if in.IsNull() {
				...
				easyjsonAc132a5fDecodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBar1(in, &*out.Request)
			}
			RequestSet = true
		case "entityUUID":
...
func easyjsonAc132a5fEncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBarBarArgWithParamsAndDuplicateFields1(out *jwriter.Writer, in Bar_ArgWithParamsAndDuplicateFields_Args) {
	...
	_ = first
	{
		...
		if in.Request == nil {
			...
			easyjsonAc132a5fEncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBar1(out, *in.Request)
		}
	}
	{
...
func easyjsonAc132a5fDecodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBar1(in *jlexer.Lexer, out *RequestWithDuplicateType) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "request1":
			if in.IsNull() {
				...
				easyjsonAc132a5fDecodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBar2(in, &*out.Request1)
			}
		case "request2":
			if in.IsNull() {
				in.Skip()
				...
				easyjsonAc132a5fDecodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBar2(in, &*out.Request2)
			}
		default:
			in.SkipRecursive()
		}
...
func easyjsonAc132a5fEncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBar1(out *jwriter.Writer, in RequestWithDuplicateType) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Request1 != nil {
		...
		easyjsonAc132a5fEncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBar2(out, *in.Request1)
	}
	if in.Request2 != nil {
		...
		easyjsonAc132a5fEncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBar2(out, *in.Request2)
	}
	out.RawByte('}')
}
func easyjsonAc132a5fDecodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBar2(in *jlexer.Lexer, out *BarRequest) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonAc132a5fEncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBar2(out *jwriter.Writer, in BarRequest) {
	out.RawByte('{')
	first := true
	_ = first
	{
