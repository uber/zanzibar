...
type _Set_BarResponse_Zapper []*BarResponse

// MarshalLogArray implements zapcore.ArrayMarshaler, enabling
// fast logging of _Set_BarResponse_Zapper.
func (s _Set_BarResponse_Zapper) MarshalLogArray(enc zapcore.ArrayEncoder) (err error) {
	for _, v := range s {
...
func (v *Echo_EchoStructSet_Args) MarshalLogObject(enc zapcore.ObjectEncoder) (err error) {
	...
	err = multierr.Append(err, enc.AddArray("arg", (_Set_BarResponse_Zapper)(v.Arg)))
	return err
}
...
func (v *Echo_EchoStructSet_Result) MarshalLogObject(enc zapcore.ObjectEncoder) (err error) {
	...
	if v.Success != nil {
		err = multierr.Append(err, enc.AddArray("success", (_Set_BarResponse_Zapper)(v.Success)))
	}
	return err
}
