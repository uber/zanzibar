...
func (v *BarException) GetStringField() (o string) { return v.StringField }
...
// GetStringField returns the value of StringField if it is set or its
// zero value if it is unset.
func (v *BarRequest) GetStringField() (o string) { return v.StringField }

// GetBoolField returns the value of BoolField if it is set or its
// zero value if it is unset.
func (v *BarRequest) GetBoolField() (o bool) { return v.BoolField }

// GetBinaryField returns the value of BinaryField if it is set or its
// zero value if it is unset.
func (v *BarRequest) GetBinaryField() (o []byte) { return v.BinaryField }
...
// zero value if it is unset.
func (v *BarRequest) GetTimestamp() (o Timestamp) { return v.Timestamp }

// GetEnumField returns the value of EnumField if it is set or its
// zero value if it is unset.
func (v *BarRequest) GetEnumField() (o Fruit) { return v.EnumField }

// GetLongField returns the value of LongField if it is set or its
// zero value if it is unset.
func (v *BarRequest) GetLongField() (o Long) { return v.LongField }
...
// zero value if it is unset.
func (v *BarRequestRecur) GetName() (o string) { return v.Name }
...
// zero value if it is unset.
func (v *BarResponseRecur) GetNodes() (o []string) { return v.Nodes }
...
// zero value if it is unset.
func (v *BarResponseRecur) GetHeight() (o int32) { return v.Height }
...
// zero value if it is unset.
func (v *ParamsStruct) GetUserUUID() (o string) { return v.UserUUID }
...
// GetName returns the value of Name if it is set or its
// zero value if it is unset.
func (v *QueryParamsOptsStruct) GetName() (o string) { return v.Name }
...
// GetName returns the value of Name if it is set or its
// zero value if it is unset.
func (v *QueryParamsStruct) GetName() (o string) { return v.Name }
...
// zero value if it is unset.
func (v *QueryParamsStruct) GetFoo() (o []string) { return v.Foo }
