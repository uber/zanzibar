	...
	for !in.IsDelim('}') {
		...
		case "opt":
			if in.IsNull() {
				...
				easyjson883a4a87DecodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBar(in, &*out.Opt)
			}
		default:
			in.SkipRecursive()
		}
...
func easyjson883a4a87EncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBarBarArgWithNestedQueryParams1(out *jwriter.Writer, in Bar_ArgWithNestedQueryParams_Args) {
	...
	if in.Opt != nil {
		...
		if in.Opt == nil {
			...
			easyjson883a4a87EncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBar(out, *in.Opt)
		}
	}
	out.RawByte('}')
}
...
func easyjson883a4a87DecodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBar(in *jlexer.Lexer, out *QueryParamsOptsStruct) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson883a4a87EncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBar(out *jwriter.Writer, in QueryParamsOptsStruct) {
	out.RawByte('{')
	first := true
	_ = first
	if !first {
