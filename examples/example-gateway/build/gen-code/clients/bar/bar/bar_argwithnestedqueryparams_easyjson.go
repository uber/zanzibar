	...
	for !in.IsDelim('}') {
		...
		case "opt":
			if in.IsNull() {
				...
				easyjson883a4a87DecodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBar1(in, &*out.Opt)
			}
		default:
			in.SkipRecursive()
		}
...
func easyjson883a4a87EncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBarBarArgWithNestedQueryParams1(out *jwriter.Writer, in Bar_ArgWithNestedQueryParams_Args) {
	...
	if in.Opt != nil {
		...
		if in.Opt == nil {
			...
			easyjson883a4a87EncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBar1(out, *in.Opt)
		}
	}
	out.RawByte('}')
}
