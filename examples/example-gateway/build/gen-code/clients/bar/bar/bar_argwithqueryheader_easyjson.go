	...
	for !in.IsDelim('}') {
		...
		case "nextResponse":
			if in.IsNull() {
				...
				easyjsonC1e6a9b9DecodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBar(in, out.NextResponse)
			}
		default:
			in.SkipRecursive()
		}
...
func easyjsonC1e6a9b9EncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBar(out *jwriter.Writer, in BarResponse) {
	...
	if in.NextResponse != nil {
		...
		easyjsonC1e6a9b9EncodeGithubComUberZanzibarExamplesExampleGatewayBuildGenCodeClientsBarBar(out, *in.NextResponse)
	}
	out.RawByte('}')
}
