...
type _Set_BazResponse_Zapper []*base.BazResponse

// MarshalLogArray implements zapcore.ArrayMarshaler, enabling
// fast logging of _Set_BazResponse_Zapper.
func (s _Set_BazResponse_Zapper) MarshalLogArray(enc zapcore.ArrayEncoder) (err error) {
	for _, v := range s {
...
func (v *SecondService_EchoStructSet_Args) MarshalLogObject(enc zapcore.ObjectEncoder) (err error) {
	...
	err = multierr.Append(err, enc.AddArray("arg", (_Set_BazResponse_Zapper)(v.Arg)))
	return err
}
...
func (v *SecondService_EchoStructSet_Result) MarshalLogObject(enc zapcore.ObjectEncoder) (err error) {
	...
	if v.Success != nil {
		err = multierr.Append(err, enc.AddArray("success", (_Set_BazResponse_Zapper)(v.Success)))
	}
	return err
}
