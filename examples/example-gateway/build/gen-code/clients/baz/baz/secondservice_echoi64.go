...
var SecondService_EchoI64_Helper = struct {
	Args           func(arg int64) *SecondService_EchoI64_Args
...
func init() {
	SecondService_EchoI64_Helper.Args = func(arg int64) *SecondService_EchoI64_Args {
		return &SecondService_EchoI64_Args{Arg: arg}
	}
