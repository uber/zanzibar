...
type BarResponse struct {
	StringField        string           `json:"stringField"`
	IntWithRange       int32            `json:"intWithRange"`
	IntWithoutRange    int32            `json:"intWithoutRange"`
	MapIntWithRange    map[string]int32 `json:"mapIntWithRange"`
	MapIntWithoutRange map[string]int32 `json:"mapIntWithoutRange"`
}
...
func (v *BarResponse) Equals(rhs *BarResponse) bool {
	...
	if !_Map_String_I32_EqualsHashable(v.MapIntWithRange, rhs.MapIntWithRange) {
		return false
	}
	if !_Map_String_I32_EqualsHashable(v.MapIntWithoutRange, rhs.MapIntWithoutRange) {
		return false
	}
	return true
}
