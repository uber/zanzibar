...
import (
	mc "github.com/uber/zanzibar/v1/examples/example-gateway/build/clients/quux/mock-client"
	"github.com/uber/zanzibar/v1/examples/example-gateway/build/gen-code/clients-idl/clients/foo/base/base"
)
