...
struct QueryParamsStruct {
    1: required string name	(zanzibar.http.ref = "query.name")    // hack assumes caller
    2: optional string userUUID	(zanzibar.http.ref = "query.userUUID")  // hack
...
service Bar {
    ...
    BarResponse argWithQueryParams(
        ...
        5: optional set<i32> baz	(zanzibar.http.ref = "query.baz")
        6: optional set<string> bazbaz	(zanzibar.http.ref = "query.bazbaz")
    ...
    BarResponse argWithNestedQueryParams(
        1: required QueryParamsStruct request	(zanzibar.http.ref = "query.request")
        2: optional QueryParamsOptsStruct opt	(zanzibar.http.ref = "query.opt")
    ) (
        zanzibar.http.method = "GET"
