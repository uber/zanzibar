...
check-licence:
	...
	./node_modules/.bin/uber-licence --dry --file '*.go' --dir '!vendor' --dir '!examples' --dir '!.tmp_gen' --dir '!gen-code' --dir '!mocks'

.PHONY: fix-licence
fix-licence:
	ls ./node_modules/.bin/uber-licence 2>/dev/null || npm i uber-licence
	./node_modules/.bin/uber-licence --file '*.go' --dir '!vendor' --dir '!examples' --dir '!.tmp_gen' --dir '!gen-code' --dir '!mocks'
